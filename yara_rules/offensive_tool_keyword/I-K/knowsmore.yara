rule knowsmore
{
    ...
    strings:
        ...
        $string1 = /\s\-\-bloodhound\s\-\-import\-data\s/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string2 = /\s\-\-bloodhound\s\-\-mark\-owned\s/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string3 = /\s\-\-bloodhound\s\-\-sync\s/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        ...
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string22 = /\s\-\-ntlm\-hash\s\-\-company\s.{0,1000}\s\-\-import\-cracked\s/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string23 = /\s\-\-ntlm\-hash\s\-\-export\-hashes\s/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string24 = /\s\-\-ntlm\-hash\s\-\-import\-ntds\s.{0,1000}\.ntds/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string25 = /\s\-\-secrets\-dump\s\-target\s/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        ...
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string72 = /BloodHound\sZIP\sFile\sidentified\,\sextracting/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        ...
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string82 = /Dumping\scached\sdomain\slogon\sinformation\s/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        ...
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string89 = /from\sknowsmore\simport\sknowsmore/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string90 = /helviojunior\/knowsmore/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string91 = /knowsmore\s\-\-create\-db/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string92 = /New\spassword\scracked\!\sMTLM\:\s/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string93 = /NTDSHashes\.dump/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string94 = /pip\sinstall\sknowsmore/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string95 = /pip3\sinstall\s\-\-upgrade\sknowsmore/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string96 = /Policy\sSPN\starget\sname\svalidation\smight\sbe\srestricting\sfull\sDRSUAPI\sdump/ nocase ascii wide
        // Description: KnowsMore is a swiss army knife tool for pentesting Microsoft Active Directory (NTLM Hashes - BloodHound - NTDS and DCSync).
        // Reference: https://github.com/helviojunior/knowsmore
        $string97 = /vssadmin\sdelete\sshadows\s\/shadow\=/ nocase ascii wide
