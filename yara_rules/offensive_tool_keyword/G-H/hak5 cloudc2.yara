rule hak5_cloudc2
{
    ...
    strings:
        ...
        // Description: Cloud C2 makes it easy for pentesters and security teams to deploy and manage Hak5 gear from the cloud
        // Reference: https://shop.hak5.org/products/c2?
        $string18 = /\\Users\\.{0,1000}\\c2\.db/ nocase ascii wide
        // Description: Cloud C2 makes it easy for pentesters and security teams to deploy and manage Hak5 gear from the cloud
        // Reference: https://shop.hak5.org/products/c2?
        ...
        // Description: Cloud C2 makes it easy for pentesters and security teams to deploy and manage Hak5 gear from the cloud
        // Reference: https://shop.hak5.org/products/c2?
        $string29 = "Cloud C2 must be run from the command line" nocase ascii wide
        // Description: Cloud C2 makes it easy for pentesters and security teams to deploy and manage Hak5 gear from the cloud
        // Reference: https://shop.hak5.org/products/c2?
        $string30 = "Cloud C2 will work behind a reverse proxy" nocase ascii wide
        // Description: Cloud C2 makes it easy for pentesters and security teams to deploy and manage Hak5 gear from the cloud
        // Reference: https://shop.hak5.org/products/c2?
