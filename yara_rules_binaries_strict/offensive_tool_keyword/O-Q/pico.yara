rule pico
{
    ...
    strings:
        ...
        // Description: hacker labs - open source and managed web services leveraging SSH
        // Reference: https://github.com/picosh/pico
        $string83 = /scp\s.{0,100}\sfeeds\.sh\:\// nocase ascii wide
        // Description: hacker labs - open source and managed web services leveraging SSH
        // Reference: https://github.com/picosh/pico
        $string84 = /scp\s.{0,100}\sprose\.sh\:\// nocase ascii wide
        // Description: hacker labs - open source and managed web services leveraging SSH
        // Reference: https://github.com/picosh/pico
        $string85 = /ssh\s\-L\s.{0,100}\:localhost\:80\s\-N\simgs\.sh/ nocase ascii wide
        // Description: hacker labs - open source and managed web services leveraging SSH
        // Reference: https://github.com/picosh/pico
        $string86 = /ssh\s\-R\s.{0,100}\:80\:localhost\:8000\stuns\.sh/ nocase ascii wide
        // Description: hacker labs - open source and managed web services leveraging SSH
        // Reference: https://github.com/picosh/pico
