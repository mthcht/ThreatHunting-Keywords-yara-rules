rule PhpSploit
{
    ...
    strings:
        ...
        $string1 = /\s\-\-get\-backdoor/ nocase ascii wide
        // Description: Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
        // Reference: https://github.com/nil0x42/phpsploit
        ...
        // Description: Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
        // Reference: https://github.com/nil0x42/phpsploit
        $string15 = /exploit\s\-\-get\-backdoor/ nocase ascii wide
        // Description: Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
        // Reference: https://github.com/nil0x42/phpsploit
        ...
        // Description: Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
        // Reference: https://github.com/nil0x42/phpsploit
        $string20 = /phpsploit_pipe\sexploit\s/ nocase ascii wide
        // Description: Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
        // Reference: https://github.com/nil0x42/phpsploit
        $string21 = /phpsploit_pipe\sprocess\s/ nocase ascii wide
        // Description: Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
        // Reference: https://github.com/nil0x42/phpsploit
        $string22 = /phpsploit_pipe\sset\sBROWSER/ nocase ascii wide
        // Description: Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
        // Reference: https://github.com/nil0x42/phpsploit
        $string23 = /phpsploit_pipe\sset\sPROXY\s/ nocase ascii wide
        // Description: Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
        // Reference: https://github.com/nil0x42/phpsploit
