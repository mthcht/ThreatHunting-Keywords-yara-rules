rule frp
{
    ...
    strings:
        ...
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string2 = /\/frp_0\..{0,100}\..{0,100}_darwin_amd64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string3 = /\/frp_0\..{0,100}\..{0,100}_darwin_arm64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string4 = /\/frp_0\..{0,100}\..{0,100}_freebsd_amd64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string5 = /\/frp_0\..{0,100}\..{0,100}_linux_amd64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string6 = /\/frp_0\..{0,100}\..{0,100}_linux_arm\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string7 = /\/frp_0\..{0,100}\..{0,100}_linux_arm64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string8 = /\/frp_0\..{0,100}\..{0,100}_linux_mips\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string9 = /\/frp_0\..{0,100}\..{0,100}_linux_mips64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string10 = /\/frp_0\..{0,100}\..{0,100}_linux_mips64le\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string11 = /\/frp_0\..{0,100}\..{0,100}_linux_mipsle\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        ...
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string14 = /\\frp_0\..{0,100}\..{0,100}_darwin_amd64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string15 = /\\frp_0\..{0,100}\..{0,100}_darwin_arm64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string16 = /\\frp_0\..{0,100}\..{0,100}_freebsd_amd64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string17 = /\\frp_0\..{0,100}\..{0,100}_linux_amd64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string18 = /\\frp_0\..{0,100}\..{0,100}_linux_arm\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string19 = /\\frp_0\..{0,100}\..{0,100}_linux_arm64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string20 = /\\frp_0\..{0,100}\..{0,100}_linux_mips\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string21 = /\\frp_0\..{0,100}\..{0,100}_linux_mips64\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string22 = /\\frp_0\..{0,100}\..{0,100}_linux_mips64le\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string23 = /\\frp_0\..{0,100}\..{0,100}_linux_mipsle\.tar\.gz/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        ...
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string442 = /frpc\s\-c\s.{0,100}frpc\.ini/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string443 = "frpc reload -c " nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string444 = "frpc status -c " nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string445 = "frpc verify -c " nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        ...
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string448 = /frps\s\-c\s.{0,100}frps\.toml/ nocase ascii wide
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        ...
        // Description: A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet.
        // Reference: https://github.com/fatedier/frp
        $string451 = "ssh -o 'proxycommand socat - " nocase ascii wide
