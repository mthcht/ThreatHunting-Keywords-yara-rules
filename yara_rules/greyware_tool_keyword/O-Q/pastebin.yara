rule pastebin
{
    ...
    strings:
        ...
        $string1 = /.{0,1000}pastebin\.com.{0,1000}\/raw\/.{0,1000}\s/ nocase ascii wide
        // Description: pastebin raw access content - abused by malwares to retrieve payloads
        // Reference: pastebin.com
        $string2 = /.{0,1000}pastebin\.com.{0,1000}\/rw\/.{0,1000}/ nocase ascii wide
        // Description: pastebin POST url - abused by malwares to exfiltrate informations
        // Reference: pastebin.com
        $string3 = /.{0,1000}pastebin\.com.{0,1000}api\/api_post\.php.{0,1000}/ nocase ascii wide
