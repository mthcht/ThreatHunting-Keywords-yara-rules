rule SharpShares
{
    ...
    strings:
        ...
        // Description: Multithreaded C# .NET Assembly to enumerate accessible network shares in a domain
        // Reference: https://github.com/mitchmoser/SharpShares
        $string2 = /\(\&\(objectCategory\=computer\)\(\!\(userAccountControl\:1\.2\.840\.113556\.1\.4\.803\:\=2\)\)\(operatingSystem\=.{0,1000}server.{0,1000}\)\(\!\(userAccountControl\:1\.2\.840\.113556\.1\.4\.803\:\=8192\)\)\(\!\(userAccountControl\:1\.2\.840\.113556\.1\.4\.803\:\=67100867\)\)\)/ nocase ascii wide
        // Description: Multithreaded C# .NET Assembly to enumerate accessible network shares in a domain
        // Reference: https://github.com/mitchmoser/SharpShares
        ...
        // Description: Multithreaded C# .NET Assembly to enumerate accessible network shares in a domain
        // Reference: https://github.com/Hackcraft-Labs/SharpShares
        $string9 = /\[\+\]\sStarting\sshare\senumeration\sagainst\s.{0,1000}\shosts/ nocase ascii wide
        // Description: Multithreaded C# .NET Assembly to enumerate accessible network shares in a domain
        // Reference: https://github.com/Hackcraft-Labs/SharpShares
        ...
        // Description: Multithreaded C# .NET Assembly to enumerate accessible network shares in a domain
        // Reference: https://github.com/Hackcraft-Labs/SharpShares
        $string45 = /execute\-assembly\s.{0,1000}\.exe\s\/ldap\:all\s\/filter\:sysvol.{0,1000}netlogon.{0,1000}ipc\$.{0,1000}print\$/ nocase ascii wide
        // Description: Multithreaded C# .NET Assembly to enumerate accessible network shares in a domain
        // Reference: https://github.com/Hackcraft-Labs/SharpShares
        ...
        // Description: Multithreaded C# .NET Assembly to enumerate accessible network shares in a domain
        // Reference: https://github.com/Hackcraft-Labs/SharpShares
        $string48 = "namespace SharpShares" nocase ascii wide
        // Description: Multithreaded C# .NET Assembly to enumerate accessible network shares in a domain
        // Reference: https://github.com/Hackcraft-Labs/SharpShares
