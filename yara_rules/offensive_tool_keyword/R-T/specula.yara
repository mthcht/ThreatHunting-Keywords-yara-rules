rule specula
{
    ...
    strings:
        ...
        // Description: Specula is a C2 framework that allows for interactive operations of an implant that runs purely in the context of outlook
        // Reference: https://github.com/trustedsec/specula
        $string261 = /SELECT\s.{0,1000}\sFROM\sWin32_GroupUser\sWHERE\sGroupComponent\=Win32_Group\.Domain\=VARIABLE\,Name\=\'Administrators\'/ nocase ascii wide
        // Description: Specula is a C2 framework that allows for interactive operations of an implant that runs purely in the context of outlook
        // Reference: https://github.com/trustedsec/specula
        $string262 = /set\swebserver_address\shashcapture\.com/ nocase ascii wide
        // Description: Specula is a C2 framework that allows for interactive operations of an implant that runs purely in the context of outlook
        // Reference: https://github.com/trustedsec/specula
        $string263 = "Specula C2" nocase ascii wide
        // Description: Specula is a C2 framework that allows for interactive operations of an implant that runs purely in the context of outlook
        // Reference: https://github.com/trustedsec/specula
        ...
        // Description: Specula is a C2 framework that allows for interactive operations of an implant that runs purely in the context of outlook
        // Reference: https://github.com/trustedsec/specula
        $string266 = "usemodule operation/file/put_file" nocase ascii wide
        // Description: Specula is a C2 framework that allows for interactive operations of an implant that runs purely in the context of outlook
        // Reference: https://github.com/trustedsec/specula
