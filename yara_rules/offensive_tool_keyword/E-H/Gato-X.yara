rule Gato_X
{
    ...
    strings:
        ...
        // Description: automate advanced enumeration and exploitation techniques against GitHub repositories and organizations
        // Reference: https://github.com/adnanekhan/Gato-X
        $string23 = /gato\-x\sattack\s/ nocase ascii wide
        // Description: automate advanced enumeration and exploitation techniques against GitHub repositories and organizations
        // Reference: https://github.com/adnanekhan/Gato-X
        $string24 = /gato\-x\senum\s/ nocase ascii wide
        // Description: automate advanced enumeration and exploitation techniques against GitHub repositories and organizations
        // Reference: https://github.com/adnanekhan/Gato-X
        $string25 = /gato\-x\ssearch\s/ nocase ascii wide
        // Description: automate advanced enumeration and exploitation techniques against GitHub repositories and organizations
        // Reference: https://github.com/adnanekhan/Gato-X
        ...
        // Description: automate advanced enumeration and exploitation techniques against GitHub repositories and organizations
        // Reference: https://github.com/adnanekhan/Gato-X
        $string33 = /pip\sinstall\sgato\-x/ nocase ascii wide
