rule lsassy
{
    ...
    strings:
        ...
        $string1 = /\s\-\sRemote\slsass\sdump\sreader/ nocase ascii wide
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        ...
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        $string5 = /\sdump\s\-\-usermode\s\-\-kernelmode\s\-\-driver\s/ nocase ascii wide
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        ...
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        $string10 = /\slsassy/ nocase ascii wide
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        ...
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        $string87 = /lsassy\s/ nocase ascii wide
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        ...
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        $string98 = /\-m\sdumpert\s/ nocase ascii wide
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        ...
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
        $string103 = /pip\sinstall\slsassy/ nocase ascii wide
        // Description: Extract credentials from lsass remotely
        // Reference: https://github.com/login-securite/lsassy
