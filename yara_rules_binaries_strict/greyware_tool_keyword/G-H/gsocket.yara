rule gsocket
{
    ...
    strings:
        ...
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string2 = /\sgsocket\-.{0,100}\.tar\.gz/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string3 = /\sgsocket_.{0,100}_all\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string4 = /\snc\s.{0,100}\.gsocket/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string5 = " nc gsocket 31337" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string6 = " --remote gsocket" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string7 = " --rm -it --name gsocket" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string8 = /\sssh\s.{0,100}\@gsocket/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string9 = " start gs-sshd" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        ...
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string16 = /\/gsocket_.{0,100}_all\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string17 = /\/gsocket_.{0,100}_x86_64\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string18 = /\/gsocket_.{0,100}aarch64\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string19 = /\/gsocket_.{0,100}arm\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string20 = /\/gsocket_.{0,100}armv6\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string21 = /\/gsocket_.{0,100}armv7l\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string22 = /\/gsocket_.{0,100}i686\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string23 = /\/gsocket_.{0,100}mips32\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string24 = /\/gsocket_.{0,100}mips64\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string25 = /\/gsocket_.{0,100}mipsel\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        ...
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string45 = /\\gsocket_.{0,100}_all\.deb/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        ...
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string138 = "apt install gsocket" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string139 = "apt-get install gsocket" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        ...
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string188 = "gs-full-pipe -s " nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        ...
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string204 = "gsocket /usr/sbin/sshd" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string205 = "gsocket -k " nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string206 = "gsocket openvpn --" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string207 = "gsocket ssh " nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        ...
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string215 = "gs-sftp -l" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string216 = "gs-sftp -s thctestserver" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        ...
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string219 = "Installing systemwide remote access permanentally" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string220 = /Join\sus\son\sTelegram\s\-\shttps\:\/\/t\.me\/thcorg/ nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string221 = "Running: netcat " nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string222 = "socat - TCP_LISTEN:31337" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string223 = "TCP:gsocket:31337" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
        $string224 = "Testing Global Socket Relay Network" nocase ascii wide
        // Description: The Global Socket Tookit allows two users behind NAT/Firewall to establish a TCP connection with each other. Securely.
        // Reference: https://github.com/hackerschoice/gsocket
