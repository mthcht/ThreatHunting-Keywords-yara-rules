rule merlin
{
    ...
    strings:
        ...
        // Description: Merlin is a cross-platform post-exploitation HTTP/2 Command & Control server and agent written in golang.
        // Reference: https://github.com/Ne0nd0g/merlin
        $string3 = /merlinAgent\-.*\.7z/ nocase ascii wide
        // Description: Merlin is a cross-platform post-exploitation HTTP/2 Command & Control server and agent written in golang.
        // Reference: https://github.com/Ne0nd0g/merlin
        $string4 = /merlinAgent\-.*\.exe/ nocase ascii wide
        // Description: Merlin is a cross-platform post-exploitation HTTP/2 Command & Control server and agent written in golang.
        // Reference: https://github.com/Ne0nd0g/merlin
        ...
        // Description: Merlin is a cross-platform post-exploitation HTTP/2 Command & Control server and agent written in golang.
        // Reference: https://github.com/Ne0nd0g/merlin
        $string7 = /merlinServer\-.*\.7z/ nocase ascii wide
        // Description: Merlin is a cross-platform post-exploitation HTTP/2 Command & Control server and agent written in golang.
        // Reference: https://github.com/Ne0nd0g/merlin
        $string8 = /merlinServer\-.*\.exe/ nocase ascii wide
        // Description: Merlin is a cross-platform post-exploitation HTTP/2 Command & Control server and agent written in golang.
        // Reference: https://github.com/Ne0nd0g/merlin
