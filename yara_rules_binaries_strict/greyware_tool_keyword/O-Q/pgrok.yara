rule pgrok
{
    ...
    strings:
        ...
        $string1 = " install pgrok" nocase ascii wide
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        ...
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        $string10 = /\/pgrokd_.{0,100}\.zip/ nocase ascii wide
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        ...
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        $string16 = /\\pgrokd_.{0,100}\.zip/ nocase ascii wide
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        $string17 = ">Poor man's ngrok<" nocase ascii wide
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        ...
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        $string118 = "pgrok http " nocase ascii wide
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        $string119 = "pgrok init --" nocase ascii wide
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        $string120 = "pgrok tcp " nocase ascii wide
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        ...
        // Description: Poor man's ngrok - a multi-tenant HTTP/TCP reverse tunnel solution through SSH remote port forwarding
        // Reference: https://github.com/pgrok/pgrok
        $string123 = "Reverse tunnel server started" nocase ascii wide
