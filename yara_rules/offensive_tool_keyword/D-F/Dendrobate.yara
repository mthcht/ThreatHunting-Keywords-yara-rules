rule Dendrobate
{
    ...
    strings:
        ...
        // Description: Dendrobate is a framework that facilitates the development of payloads that hook unmanaged code through managed .NET code
        // Reference: https://github.com/FuzzySecurity/Dendrobate
        $string16 = /dendron.*FileMonInject\.dll/ nocase ascii wide
        // Description: Dendrobate is a framework that facilitates the development of payloads that hook unmanaged code through managed .NET code
        // Reference: https://github.com/FuzzySecurity/Dendrobate
        $string17 = /EasyHook\-Managed.*InjectionLoader\.cs/ nocase ascii wide
        // Description: Dendrobate is a framework that facilitates the development of payloads that hook unmanaged code through managed .NET code
        // Reference: https://github.com/FuzzySecurity/Dendrobate
        $string18 = /EasyHook\-Managed.*WOW64Bypass\./ nocase ascii wide
        // Description: Dendrobate is a framework that facilitates the development of payloads that hook unmanaged code through managed .NET code
        // Reference: https://github.com/FuzzySecurity/Dendrobate
