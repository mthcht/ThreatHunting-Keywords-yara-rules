rule SentinelAgent
{
    ...
    strings:
        ...
        // Description: dump a process with SentinelAgent.exe
        // Reference: https://gist.github.com/adamsvoboda/8e248c6b7fb812af5d04daba141c867e
        $string6 = /DumpProcessPid\s\-targetPID\s.*\s\-outputFile/ nocase ascii wide
        // Description: dump a process with SentinelAgent.exe
        // Reference: https://gist.github.com/adamsvoboda/8e248c6b7fb812af5d04daba141c867e
        $string7 = /TakeDump\s\-SentinelHelper\s.*\s\-ProcessId\s.*\s\-User\s.*\s\-Kernel\s/ nocase ascii wide
        // Description: dump a process with SentinelAgent.exe
        // Reference: https://gist.github.com/adamsvoboda/8e248c6b7fb812af5d04daba141c867e
