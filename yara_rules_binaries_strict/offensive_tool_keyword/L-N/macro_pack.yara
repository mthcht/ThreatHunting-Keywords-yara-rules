rule macro_pack
{
    ...
    strings:
        ...
        $string1 = /\s\-\-bypass\s\-\-stealth\s\-\-antisandox/ nocase ascii wide
        // Description: The macro_pack is a tool used to automatize obfuscation and generation of retro formats such as MS Office documents or VBS like format. Now it also handles various shortcuts formats.
        // Reference: https://github.com/sevagas/macro_pack
        ...
        // Description: The macro_pack is a tool used to automatize obfuscation and generation of retro formats such as MS Office documents or VBS like format. Now it also handles various shortcuts formats.
        // Reference: https://github.com/sevagas/macro_pack
        $string70 = /cmd\s\/c\sping\slocalhost\s\-n\s1\\"/ nocase ascii wide
        // Description: The macro_pack is a tool used to automatize obfuscation and generation of retro formats such as MS Office documents or VBS like format. Now it also handles various shortcuts formats.
        // Reference: https://github.com/sevagas/macro_pack
        ...
        // Description: The macro_pack is a tool used to automatize obfuscation and generation of retro formats such as MS Office documents or VBS like format. Now it also handles various shortcuts formats.
        // Reference: https://github.com/sevagas/macro_pack
        $string92 = /msfvenom\s\-p\s/ nocase ascii wide
        // Description: The macro_pack is a tool used to automatize obfuscation and generation of retro formats such as MS Office documents or VBS like format. Now it also handles various shortcuts formats.
        // Reference: https://github.com/sevagas/macro_pack
        $string93 = /REM\sGenerate\smeterpreter\sdll\spayload/ nocase ascii wide
        // Description: The macro_pack is a tool used to automatize obfuscation and generation of retro formats such as MS Office documents or VBS like format. Now it also handles various shortcuts formats.
        // Reference: https://github.com/sevagas/macro_pack
