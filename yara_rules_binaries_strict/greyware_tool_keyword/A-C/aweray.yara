rule aweray
{
    ...
    strings:
        ...
        // Description: all-in-one secure remote access control and support solution
        // Reference: sun.aweray.com
        $string2 = /\/Aweray_Remote_.{0,100}\.exe/ nocase ascii wide
        // Description: all-in-one secure remote access control and support solution
        // Reference: sun.aweray.com
        $string3 = /\/Aweray_Remote_.{0,100}\.zip/ nocase ascii wide
        // Description: all-in-one secure remote access control and support solution
        // Reference: sun.aweray.com
        $string4 = /\\Aweray\sRemote\.lnk/ nocase ascii wide
        // Description: all-in-one secure remote access control and support solution
        // Reference: sun.aweray.com
        $string5 = /\\Aweray_Remote_.{0,100}\.exe/ nocase ascii wide
        // Description: all-in-one secure remote access control and support solution
        // Reference: sun.aweray.com
        $string6 = /\\Aweray_Remote_.{0,100}\.zip/ nocase ascii wide
        // Description: all-in-one secure remote access control and support solution
        // Reference: sun.aweray.com
        ...
        // Description: all-in-one secure remote access control and support solution
        // Reference: sun.aweray.com
        $string20 = /https\:\/\/sun\.aweray\.com\/.{0,100}\/download/ nocase ascii wide
        // Description: all-in-one secure remote access control and support solution
        // Reference: sun.aweray.com
        $string21 = /install\.bat\sAweSun/ nocase ascii wide
        // Description: all-in-one secure remote access control and support solution
        // Reference: sun.aweray.com
        $string22 = /netsh\s\sadvfirewall\sfirewall\s.{0,100}\srule\sname\=\\"AweSun/ nocase ascii wide
