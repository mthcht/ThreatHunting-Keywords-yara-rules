rule EarthWorm
{
    ...
    strings:
        ...
        // Description: SOCKS v5 proxy service used for data forwarding in complex network environments
        // Reference: https://github.com/rootkiter/Binary-files/tree/212c43b40e2e4c2e2703400caaa732557b6080a4
        $string2 = /\/ew\s\-s\slcx_listen\s\-/ nocase ascii wide
        // Description: SOCKS v5 proxy service used for data forwarding in complex network environments
        // Reference: https://github.com/rootkiter/Binary-files/tree/212c43b40e2e4c2e2703400caaa732557b6080a4
        $string3 = /\/ew\s\-s\slcx_slave\s\-/ nocase ascii wide
        // Description: SOCKS v5 proxy service used for data forwarding in complex network environments
        // Reference: https://github.com/rootkiter/Binary-files/tree/212c43b40e2e4c2e2703400caaa732557b6080a4
        $string4 = /\/ew\s\-s\slcx_tran\s\-/ nocase ascii wide
        // Description: SOCKS v5 proxy service used for data forwarding in complex network environments
        // Reference: https://github.com/rootkiter/Binary-files/tree/212c43b40e2e4c2e2703400caaa732557b6080a4
        $string5 = /\/ew\s\-s\srcsocks\s\-/ nocase ascii wide
        // Description: SOCKS v5 proxy service used for data forwarding in complex network environments
        // Reference: https://github.com/rootkiter/Binary-files/tree/212c43b40e2e4c2e2703400caaa732557b6080a4
        $string6 = /\/ew\s\-s\sssocksd\s\-/ nocase ascii wide
        // Description: SOCKS v5 proxy service used for data forwarding in complex network environments
        // Reference: https://github.com/rootkiter/Binary-files/tree/212c43b40e2e4c2e2703400caaa732557b6080a4
