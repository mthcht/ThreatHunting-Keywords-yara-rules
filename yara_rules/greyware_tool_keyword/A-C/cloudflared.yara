rule cloudflared
{
    ...
    strings:
        ...
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string5 = /\/cloudflared\-linux\-.{0,1000}\.deb/
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string6 = /\/cloudflared\-linux\-.{0,1000}\.rpm/
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        ...
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string32 = "cloudflared tunnel create " nocase ascii wide
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string33 = "cloudflared tunnel info " nocase ascii wide
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string34 = "cloudflared tunnel list" nocase ascii wide
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string35 = "cloudflared tunnel login" nocase ascii wide
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string36 = "cloudflared tunnel route dns " nocase ascii wide
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string37 = "cloudflared tunnel route ip add " nocase ascii wide
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string38 = "cloudflared tunnel route ip show" nocase ascii wide
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string39 = "cloudflared tunnel run " nocase ascii wide
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        ...
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string48 = /echo\s\'alias\scat\=\/bin\/bash\s\-c\s\'bash\s\-i\s\>\&\s\/dev\/tcp\/.{0,1000}\/.{0,1000}\s0\>\&1\'\'\s\>\>\s.{0,1000}\/\.bashrc.{0,1000}\s/
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
        $string49 = /echo\s\'alias\sfind\=\/bin\/bash\s\-c\s\'bash\s\-i\s\>\&\s\/dev\/tcp\/.{0,1000}\/.{0,1000}\>\>\s\\"\$user\/\.bashrc\\"/
        // Description: cloudfared Contains the command-line client for Cloudflare Tunnel - a tunneling daemon that proxies traffic from the Cloudflare network to your origins
        // Reference: https://github.com/cloudflare/cloudflared
