rule powershell
{
    ...
    strings:
        ...
        // Reference: N/A
        $string6 = /\s\-W\sHidden\s\-command\s.{0,100}https\:\/\/.{0,100}Invoke\-WebRequest.{0,100}\;\siex\s\$/ nocase ascii wide
        // Description: A PowerShell process downloaded and launched a remote file
        // Reference: N/A
        $string7 = /\s\-W\sHidden\s\-command\s.{0,100}Invoke\-WebRequest.{0,100}https\:\/\/.{0,100}\;\siex\s\$/ nocase ascii wide
        ...
        // Reference: N/A
        $string10 = /\\powershell\.exe.{0,100}\s\+\=\shidden/ nocase ascii wide
        // Description: command aiming to hide a file. It can be performed with  powershell on a WINDOWS machine with command option =hidden
        // Reference: N/A
        $string11 = /\\powershell\.exe.{0,100}\s\+\=hidden/ nocase ascii wide
        // Description: command aiming to hide a file. It can be performed with  powershell on a WINDOWS machine with command option =hidden
        // Reference: N/A
        $string12 = /\\powershell\.exe.{0,100}\s\=\shidden/ nocase ascii wide
        // Description: command aiming to hide a file.  It can be performed with  powershell on a WINDOWS machine with command option =hidden
        // Reference: N/A
        $string13 = /\\powershell\.exe.{0,100}\s\=hidden/ nocase ascii wide
        ...
        $string16 = /Add\-DnsClientDohServerAddress\s.{0,100}\-ServerAddress\s/ nocase ascii wide
        ...
        // Reference: N/A
        $string19 = /Add\-MpPreference\s\-ExclusionProcess\s.{0,100}\\Windows\\System32\\WindowsPowerShell\\v1\.0\\powershell\.exe/ nocase ascii wide
        // Description: allows all users to access all computers with a specified configuration
        // Reference: N/A
        $string20 = /Add\-PswaAuthorizationRule\s\-UsernName\s\\.{0,100}\s\-ComputerName\s\\.{0,100}\s\-ConfigurationName\s\\/ nocase ascii wide
        ...
        $string21 = /Add\-PswaAuthorizationRule.{0,100}\-ComputerName\s/ nocase ascii wide
        // Description: enable the PowerShell Web Access featur which could be used for remote access and potential
        // Reference: https://www.cisa.gov/sites/default/files/2024-08/aa24-241a-iran-based-cyber-actors-enabling-ransomware-attacks-on-us-organizations_0.pdf
        $string22 = /Add\-PswaAuthorizationRule.{0,100}\-UserName\s/ nocase ascii wide
        // Description: enable the PowerShell Web Access featur which could be used for remote access and potential
        // Reference: https://www.cisa.gov/sites/default/files/2024-08/aa24-241a-iran-based-cyber-actors-enabling-ransomware-attacks-on-us-organizations_0.pdf
        $string23 = /Add\-PswaAuthorizationRule.{0,100}\-UserName\s/ nocase ascii wide
        ...
        // Reference: N/A
        $string30 = /copy\-item\s.{0,100}\\roaming\\microsoft\\windows\\start\smenu\\programs\\startup/ nocase ascii wide
        // Description: enable the PowerShell Web Access featur which could be used for remote access and potential
        // Reference: https://www.cisa.gov/sites/default/files/2024-08/aa24-241a-iran-based-cyber-actors-enabling-ransomware-attacks-on-us-organizations_0.pdf
        ...
        // Description: enable the PowerShell Web Access featur which could be used for remote access and potential
        // Reference: https://www.cisa.gov/sites/default/files/2024-08/aa24-241a-iran-based-cyber-actors-enabling-ransomware-attacks-on-us-organizations_0.pdf
        $string33 = /dism\.exe.{0,100}\/enable\-feature.{0,100}WindowsPowerShellWebAccess\s/ nocase ascii wide
        ...
        // Reference: https://vx-underground.org/Archive/Dispossessor%20Leaks
        $string46 = /foreach\s\(\$.{0,100}\s\{Test\-NetConnection\s\-Port\s/ nocase ascii wide
        // Description: alternativeto whoami
        // Reference: N/A
        ...
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string50 = /Get\-ADGroup\s\-Filter\s.{0,100}Name\s\-like\s.{0,100}admin/ nocase ascii wide
        ...
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string52 = /Get\-ADObject\s\-Filter\s\{msDS\-AllowedToDelegateTo\s.{0,100}\s\-Properties\smsDS\-AllowedToDelegateTo/ nocase ascii wide
        // Description: Enumerate shadow security principals mapped to a high priv group
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string53 = /Get\-ADObject\s\-SearchBase\s.{0,100}CN\=Shadow\sPrincipal\sConfiguration.{0,100}CN\=Services.{0,100}\s\(Get\-ADRootDSE\)\.configurationNamingContext\)\s\|\sselect\s.{0,100}msDS\-ShadowPrincipalSid/ nocase ascii wide
        ...
        // Reference: N/A
        $string57 = /Get\-ChildItem\s\-Hidden\sC\:\\Users\\.{0,100}\\AppData\\Local\\Microsoft\\Credentials\\/ nocase ascii wide
        // Description: Find Potential Credential in Files - This directory often contains encrypted credentials or other sensitive files related to user accounts
        // Reference: N/A
        $string58 = /Get\-ChildItem\s\-Hidden\sC\:\\Users\\.{0,100}\\AppData\\Roaming\\Microsoft\\Credentials\\/ nocase ascii wide
        ...
        // Reference: N/A
        $string67 = /Get\-NetGroupMember\s\-GroupName\s.{0,100}DNSAdmins/ nocase ascii wide
        ...
        // Reference: N/A
        $string70 = /HostVersion\=2\.0.{0,100}EngineVersion\=2\.0/ nocase ascii wide
        ...
        $string78 = /Invoke\-WebRequest\sifconfig\.me\/ip.{0,100}Content\.Trim\(\)/ nocase ascii wide
        // Description: alternativeto whoami
        // Reference: N/A
        ...
        // Reference: N/A
        $string81 = /New\-ItemProperty\s\-Path\s\\"HKLM\:\\Software\\Microsoft\\Windows\sNT\\CurrentVersion\\Winlogon\\SpecialAccounts\\Userlist\\"\s\-Name\s.{0,100}\s\-Value\s0\s\-PropertyType\sDword/ nocase ascii wide
        ...
        // Reference: N/A
        $string83 = /New\-NetFirewallRule\s.{0,100}\s\-Enabled\sTrue\s\-Direction\sInbound\s\-Protocol\sTCP\s\-Action\sAllow\s\-LocalPort\s22/ nocase ascii wide
        ...
        $string84 = /New\-Object\sSystem\.Net\.Sockets\.TCPClient\(.{0,100}\$stream\s\=\s\$client\.GetStream\(\).{0,100}\[byte\[\]\]\$bytes\s\=\s0\.\.65535/ nocase ascii wide
        ...
        $string87 = /powershell\s\-c\s.{0,100}\\windows\\system32\\inetsrv\\appcmd\.exe\slist\sapppool\s\/\@t\:/ nocase ascii wide
        // Description: clearing powershell history
        // Reference: N/A
        $string88 = "powershell -c clear" nocase ascii wide
        // Description: Defense evasion technique In order to avoid detection at any point of the kill chain. attackers use several ways to disable anti-virus. disable Microsoft firewall and clear logs.
        // Reference: N/A
        $string89 = /powershell\sNew\-ItemProperty\s\-Path\s.{0,100}HKLM\:\\SOFTWARE\\Policies\\Microsoft\\Windows\sDefender.{0,100}\s\-Name\sDisableAntiSpyware\s\-Value\s1\s\-PropertyType\sDWORD\s\-Force/ nocase ascii wide
        ...
        $string93 = /powershell.{0,100}Uninstall\-WindowsFeature\s\-Name\sWindows\-Defender\-GUI/ nocase ascii wide
        // Description: Adversaries may attempt to execute powershell script from known accessible location
        // Reference: N/A
        $string94 = /Powershell\.exe\s\s\-windowstyle\shidden\s\-nop\s\-ExecutionPolicy\sBypass\s\s\-Commmand\s.{0,100}C\:\\Users\\.{0,100}\\AppData\\Roaming\\/ nocase ascii wide
        ...
        // Reference: https://github.com/Porchetta-Industries/CrackMapExec
        $string97 = /powershell\.exe\s\-exec\sbypass\s\-noni\s\-nop\s\-w\s1\s\-C.{0,100}invoke_obfuscation/ nocase ascii wide
        // Description: downloading from IP without domain name
        // Reference: https://www.trendmicro.com/en_us/research/24/b/threat-actor-groups-including-black-basta-are-exploiting-recent-.html
        ...
        // Reference: N/A
        $string107 = /reg\sdelete\s.{0,100}\s\/v\sMRUList\s\/f/ nocase ascii wide
        ...
        // Description: Remove  Sophos folders
        // Reference: https://vx-underground.org/Archive/Dispossessor%20Leaks
        $string110 = /Remove\-Item\s\-LiteralPath\s\\"C\:\\Program\sFiles\\Sophos.{0,100}\\"\s\-Force\s\-Recurse/ nocase ascii wide
        // Description: Remove  Sophos folders
        // Reference: https://vx-underground.org/Archive/Dispossessor%20Leaks
        $string111 = /Remove\-Item\s\-LiteralPath\s\\"C\:\\ProgramData\\Sophos\\"\s\-Force\s\-Recurse/ nocase ascii wide
        // Description: attempts to evade defenses or remove traces of activity by deleting MRUList registry keys
        // Reference: N/A
        $string112 = /Remove\-ItemProperty\s\-Path.{0,100}\s\-Name\sMRUList\s/ nocase ascii wide
        // Description: list AV products with powershell
        // Reference: N/A
        $string113 = /root\/SecurityCenter2.{0,100}\s\-ClassName\sAntiVirusProduct/ nocase ascii wide
        ...
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string115 = /Set\-ADObject\s\-SamAccountName\s.{0,100}\s\-PropertyName\sscriptpath\s\-PropertyValue\s.{0,100}\\.{0,100}\.exe/ nocase ascii wide
        ...
        // Description: stopping backup services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string128 = /Stop\-Process\s\-Name\s\\"storagecraft\simagemanager.{0,100}\\"/ nocase ascii wide
        // Description: stopping backup services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        ...
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string151 = /Stop\-Process\s\-Name\sEPSecurityService.{0,100}\s\s\s\s/ nocase ascii wide
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string152 = /Stop\-Process\s\-Name\sEPUpdateService.{0,100}\s\s\s\s\s\s\s/ nocase ascii wide
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        ...
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string164 = /Stop\-Process\s\-Name\sMBEndpointAgent.{0,100}\s\s\s\s/ nocase ascii wide
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string165 = /Stop\-Process\s\-Name\sMcAfeeEngineService.{0,100}\s\s\s\s/ nocase ascii wide
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        ...
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string205 = /Stop\-Process\s\-Name\sSntpService.{0,100}\s\s\s\s/ nocase ascii wide
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        ...
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string222 = /Stop\-Process\s\-Name\sTrueKeyScheduler.{0,100}\s\s\s\s/ nocase ascii wide
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string223 = "Stop-Process -Name TrueKeyServiceHel" nocase ascii wide
        // Description: stopping AV services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string224 = /Stop\-Process\s\-Name\svapiendpoint.{0,100}\s\s\s\s\s\s\s/ nocase ascii wide
        // Description: stopping backup services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        ...
        // Description: stopping backup services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
        $string231 = /Stop\-Process\s\-Name\sVeeamDeploySvc.{0,100}\s\s\s\s/ nocase ascii wide
        // Description: stopping backup services
        // Reference: https://github.com/TheParmak/conti-leaks-englished/blob/45d49307f347aff10e0f088af25142f8929b4c4f/anonfile_dumps/31.txt#L236
