rule pamspy
{
    ...
    strings:
        ...
        // Description: Credentials Dumper for Linux using eBPF
        // Reference: https://github.com/citronneur/pamspy
        $string3 = "/pamspy -p " nocase ascii wide
        // Description: Credentials Dumper for Linux using eBPF
        // Reference: https://github.com/citronneur/pamspy
        ...
        // Description: Credentials Dumper for Linux using eBPF
        // Reference: https://github.com/citronneur/pamspy
        $string15 = "pamspy: Failed to increase RLIMIT_MEMLOCK limit!" nocase ascii wide
        // Description: Credentials Dumper for Linux using eBPF
        // Reference: https://github.com/citronneur/pamspy
        $string16 = "pamspy: Failed to load BPF program: " nocase ascii wide
        // Description: Credentials Dumper for Linux using eBPF
        // Reference: https://github.com/citronneur/pamspy
        $string17 = "pamspy: Unable to find pam_get_authtok function in" nocase ascii wide
        // Description: Credentials Dumper for Linux using eBPF
        // Reference: https://github.com/citronneur/pamspy
