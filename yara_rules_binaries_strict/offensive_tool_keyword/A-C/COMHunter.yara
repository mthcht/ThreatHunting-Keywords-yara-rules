rule COMHunter
{
    ...
    strings:
        ...
        $string1 = /COMHunter.{0,100}\s\-inproc/ nocase ascii wide
        // Description: Enumerates COM servers set in LocalServer32 and InProc32 keys on a system using WMI
        // Reference: https://github.com/matterpreter/OffensiveCSharp/tree/master/COMHunter
        $string2 = /COMHunter.{0,100}\s\-localserver/ nocase ascii wide
        // Description: Enumerates COM servers set in LocalServer32 and InProc32 keys on a system using WMI
        // Reference: https://github.com/matterpreter/OffensiveCSharp/tree/master/COMHunter
        ...
        // Description: Enumerates COM servers set in LocalServer32 and InProc32 keys on a system using WMI
        // Reference: https://github.com/matterpreter/OffensiveCSharp/tree/master/COMHunter
        $string6 = /github.{0,100}\/COMHunter\// nocase ascii wide
