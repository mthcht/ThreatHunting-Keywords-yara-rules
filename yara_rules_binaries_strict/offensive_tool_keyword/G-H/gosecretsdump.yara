rule gosecretsdump
{
    ...
    strings:
        ...
        // Description: Dump ntds.dit really fast
        // Reference: https://github.com/C-Sto/gosecretsdump
        $string4 = /\s\-system\s.{0,100}\s\-ntds\s.{0,100}ntds\.dit/ nocase ascii wide
        // Description: Dump ntds.dit really fast
        // Reference: https://github.com/C-Sto/gosecretsdump
        ...
        // Description: Dump ntds.dit really fast
        // Reference: https://github.com/C-Sto/gosecretsdump
        $string41 = /gosecretsdump\sv.{0,100}\s\(\@C__Sto/ nocase ascii wide
        // Description: Dump ntds.dit really fast
        // Reference: https://github.com/C-Sto/gosecretsdump
        $string42 = "gosecretsdump/cmd" nocase ascii wide
        // Description: Dump ntds.dit really fast
        // Reference: https://github.com/C-Sto/gosecretsdump
        $string43 = /gosecretsdump_win.{0,100}\.exe/ nocase ascii wide
        // Description: Dump ntds.dit really fast
        // Reference: https://github.com/C-Sto/gosecretsdump
