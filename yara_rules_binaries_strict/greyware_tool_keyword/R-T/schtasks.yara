rule schtasks
{
    ...
    strings:
        ...
        // Description: SSH backdoor creation with schtasks
        // Reference: https://www.trellix.com/blogs/research/cactus-ransomware-new-strain-in-the-market/
        $string8 = /schtasks\.exe\s\/create\s\/sc\sminute\s\/mo\s1\s\/tn\s.{0,100}\s\/rl\shighest\s\/np\s\/tr\s.{0,100}\\sshd\\sshd\.exe\s\-f\s.{0,100}\\sshd\\config\\sshd_config/ nocase ascii wide
