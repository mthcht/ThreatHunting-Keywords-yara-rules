rule restic
{
    ...
    strings:
        ...
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string7 = /\/restic_.{0,1000}_windows_amd64\.zip/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string8 = /\/restic\-master\// nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string9 = /\\restic\-.{0,1000}\.tar\.gz/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string10 = /\\restic\.exe/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string11 = /\\RESTIC_.{0,1000}_WINDOWS_AMD64\.E\-FC5783E7\.pf/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string12 = /\\restic_.{0,1000}_windows_amd64\.zip/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        ...
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string472 = /apt\sinstall\srestic/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string473 = /apt\-get\sinstall\srestic/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        ...
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string655 = /http\:\/\/.{0,1000}\:9000\/restic/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string656 = /https\:\/\/.{0,1000}\:9000\/restic/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string657 = /restic\sbackup\s\-\-/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string658 = /restic\scheck\s\-\-read\-data/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string659 = /restic\sinit\s\-\-repo\s/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string660 = /restic\s\-o\ss3\.bucket\-lookup/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string661 = /restic\s\-r\s/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string662 = /restic\s\-\-repo\s/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string663 = /restic\/restic\:latest/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string664 = /restic_.{0,1000}_windows_amd64\.exe/ nocase ascii wide
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        ...
        // Description: backup program used by threat actors for data exfiltration
        // Reference: https://github.com/restic/restic
        $string668 = /winpty\srestic\s/ nocase ascii wide
