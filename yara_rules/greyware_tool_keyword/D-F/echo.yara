rule echo
{
    ...
    strings:
        ...
        // Reference: N/A
        $string7 = /echo\s\'\'\s\>\s\~\/\.bash_history/ nocase ascii wide
        ...
        // Reference: N/A
        $string8 = /echo\s0\s\>\s\/sys\/kernel\/debug\/kprobes\/enabled/ nocase ascii wide
        // Description: This command turns off tracing for a specific instance
        // Reference: N/A
        $string9 = /echo\s0\s\>\s\/sys\/kernel\/debug\/tracing\/instances\/\$.{0,1000}\/tracing_on/ nocase ascii wide
        // Description: linux command abused by attacker
        // Reference: N/A
        $string10 = /echo\s\'set\s\+o\shistory\'\s\>\>\s\/etc\/profile/ nocase ascii wide
