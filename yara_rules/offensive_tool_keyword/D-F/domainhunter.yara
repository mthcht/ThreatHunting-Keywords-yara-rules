rule domainhunter
{
    ...
    strings:
        ...
        $string1 = /.{0,1000}\sdomainhunter\s.{0,1000}/ nocase ascii wide
        // Description: Checks expired domains for categorization/reputation and Archive.org history to determine good candidates for phishing and C2 domain names 
        // Reference: https://github.com/threatexpress/domainhunter
        $string2 = /.{0,1000}\s\-\-keyword\s.{0,1000}\s\-\-check\s\-\-ocr\s.{0,1000}\s\-\-alexa.{0,1000}/ nocase ascii wide
        // Description: Checks expired domains for categorization/reputation and Archive.org history to determine good candidates for phishing and C2 domain names 
        // Reference: https://github.com/threatexpress/domainhunter
        $string3 = /.{0,1000}\/domainhunter.{0,1000}/ nocase ascii wide
        ...
        // Reference: https://github.com/threatexpress/domainhunter
        $string4 = /.{0,1000}domainhunter.{0,1000}/ nocase ascii wide
        // Description: Checks expired domains for categorization/reputation and Archive.org history to determine good candidates for phishing and C2 domain names 
        // Reference: https://github.com/threatexpress/domainhunter
        $string5 = /.{0,1000}domainhunter\.py.{0,1000}/ nocase ascii wide
        // Description: Checks expired domains for categorization/reputation and Archive.org history to determine good candidates for phishing and C2 domain names 
        // Reference: https://github.com/threatexpress/domainhunter
        $string6 = /.{0,1000}downloadMalwareDomains.{0,1000}/ nocase ascii wide
