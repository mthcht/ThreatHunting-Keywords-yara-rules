rule grep
{
    ...
    strings:
        ...
        // Reference: N/A
        $string1 = /grep\s\-.{0,100}\s.{0,100}DBPassword/
        // Description: search for passwords
        // Reference: https://github.com/RoseSecurity/Red-Teaming-TTPs/blob/main/Linux.md
        $string2 = /grep\s.{0,100}password\s\/var\/www/
        // Description: Detects suspicious shell commands indicating the information gathering phase as preparation for the Privilege Escalation. # search for plain text user/passwords
        // Reference: N/A
        $string3 = /grep\s.{0,100}password\..{0,100}\s\/etc\/.{0,100}\.conf/
        ...
        // Description: Detects suspicious shell commands indicating the information gathering phase as preparation for the Privilege Escalation. # search for plain text user/passwords
        // Reference: N/A
        $string8 = /grep\s\-roiE\s.{0,100}password/
        // Description: search for passwords
        // Reference: https://github.com/RoseSecurity/Red-Teaming-TTPs/blob/main/Linux.md
        $string9 = /grep.{0,100}\|pwd\=\|passwd\=\|password\=/
        // Description: search for passwords
        // Reference: https://github.com/RoseSecurity/Red-Teaming-TTPs/blob/main/Linux.md
        $string10 = /grep.{0,100}password\|pwd\|pass/
        // Description: search for passwords in memory and core dumps
        // Reference: https://github.com/RoseSecurity/Red-Teaming-TTPs/blob/main/Linux.md
        $string11 = /strings\s\-n\s.{0,100}\s\/dev\/mem\s\|\sgrep\s\-i\spass/
