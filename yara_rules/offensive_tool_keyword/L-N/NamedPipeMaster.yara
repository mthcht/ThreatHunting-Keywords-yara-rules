rule NamedPipeMaster
{
    ...
    strings:
        ...
        // Description: a tool used to analyze  monitor and interact with named pipes - allows dll injection and impersonation
        // Reference: https://github.com/zeze-zeze/NamedPipeMaster
        $string22 = "act as a named pipe server to be connected by other clients" nocase ascii wide
        // Description: a tool used to analyze  monitor and interact with named pipes - allows dll injection and impersonation
        // Reference: https://github.com/zeze-zeze/NamedPipeMaster
        ...
        // Description: a tool used to analyze  monitor and interact with named pipes - allows dll injection and impersonation
        // Reference: https://github.com/zeze-zeze/NamedPipeMaster
        $string31 = /inject\s.{0,1000}\.dll\sinto\sa\sprocess\sas\sa\sproxy\sto\sinteract\swith\sthe\starget\snamed\spipe\sserver/ nocase ascii wide
        // Description: a tool used to analyze  monitor and interact with named pipes - allows dll injection and impersonation
        // Reference: https://github.com/zeze-zeze/NamedPipeMaster
        $string32 = /Inject\sinto\sthe\sproxy\sprocess\sand\slet\sit\sopen\sa\snamed\spipe\sserver\./ nocase ascii wide
        // Description: a tool used to analyze  monitor and interact with named pipes - allows dll injection and impersonation
        // Reference: https://github.com/zeze-zeze/NamedPipeMaster
        $string33 = "keep monitoring named pipe activities until enter is pressed" nocase ascii wide
        // Description: a tool used to analyze  monitor and interact with named pipes - allows dll injection and impersonation
        // Reference: https://github.com/zeze-zeze/NamedPipeMaster
        ...
        // Description: a tool used to analyze  monitor and interact with named pipes - allows dll injection and impersonation
        // Reference: https://github.com/zeze-zeze/NamedPipeMaster
        $string48 = "Ring0NamedPipeFilter " nocase ascii wide
        // Description: a tool used to analyze  monitor and interact with named pipes - allows dll injection and impersonation
        // Reference: https://github.com/zeze-zeze/NamedPipeMaster
