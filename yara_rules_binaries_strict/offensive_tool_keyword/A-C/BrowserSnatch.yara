rule BrowserSnatch
{
    ...
    strings:
        ...
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string17 = /BrowserSnatch\s\-/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string18 = /BrowserSnatch\sexecuted\swith\s/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        ...
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string23 = /Chromium\sBookmarks\sSnatch\sFailed/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string24 = /Chromium\sCookie\sSnatch\sFailed/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string25 = /Chromium\sHistory\sSnatch\sFailed/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string26 = /Chromium\sPassword\sSnatch\sFailed/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        ...
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string31 = /Gecko\sBookmarks\sSnatch\sFailed/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string32 = /Gecko\sCookie\sSnatch\sFailed/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string33 = /Gecko\sHistory\sSnatch\sFailed/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string34 = /Gecko\sPassword\sSnatch\sFailed/ nocase ascii wide
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        ...
        // Description: steals important data from all chromium and gecko browsers installed in the system and gather the data in a stealer db to be exfiltrated out. A powerful Browser Stealer
        // Reference: https://github.com/shaddy43/BrowserSnatch
        $string37 = /Snatching\spasswords\s\&\scookies/ nocase ascii wide
