rule snmpwalk
{
    ...
    strings:
        ...
        $string1 = "snmpwalk  -v1 -cpublic " nocase ascii wide
        // Description: allows you to enumerate the SNMP devices and places the output in a very human readable friendly format
        // Reference: https://wiki.debian.org/SNMP
        $string2 = /snmpwalk\s.{0,100}\spublic\s.{0,100}1\.3\.6\.1\./ nocase ascii wide
        // Description: allows you to enumerate the SNMP devices and places the output in a very human readable friendly format
        // Reference: https://wiki.debian.org/SNMP
        $string3 = "snmpwalk -c public -v1 " nocase ascii wide
