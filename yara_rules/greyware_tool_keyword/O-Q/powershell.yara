rule powershell
{
    ...
    strings:
        ...
        // Reference: N/A
        $string1 = /.{0,1000}\[System\.Environment\]::GetEnvironmentVariable\(\'username\'\).{0,1000}/ nocase ascii wide
        ...
        // Reference: N/A
        $string2 = /.{0,1000}\\powershell\.exe.{0,1000}\s\+\=\shidden.{0,1000}/ nocase ascii wide
        // Description: command aiming to hide a file. It can be performed with  powershell on a WINDOWS machine with command option =hidden
        // Reference: N/A
        $string3 = /.{0,1000}\\powershell\.exe.{0,1000}\s\+\=hidden.{0,1000}/ nocase ascii wide
        // Description: command aiming to hide a file. It can be performed with  powershell on a WINDOWS machine with command option =hidden
        // Reference: N/A
        $string4 = /.{0,1000}\\powershell\.exe.{0,1000}\s\=\shidden.{0,1000}/ nocase ascii wide
        // Description: command aiming to hide a file.  It can be performed with  powershell on a WINDOWS machine with command option =hidden
        // Reference: N/A
        $string5 = /.{0,1000}\\powershell\.exe.{0,1000}\s\=hidden.{0,1000}/ nocase ascii wide
        ...
        $string6 = /.{0,1000}Add\-DnsClientDohServerAddress\s.{0,1000}\-ServerAddress\s.{0,1000}/ nocase ascii wide
        // Description: Exclude powershell from defender detections
        // Reference: N/A
        $string7 = /.{0,1000}Add\-MpPreference\s\-ExclusionProcess\s.{0,1000}\\Windows\\System32\\WindowsPowerShell\\v1\.0\\powershell\.exe.{0,1000}/ nocase ascii wide
        // Description: allows all users to access all computers with a specified configuration
        // Reference: N/A
        $string8 = /.{0,1000}Add\-PswaAuthorizationRule\s\-UsernName\s\\.{0,1000}\s\-ComputerName\s\\.{0,1000}\s\-ConfigurationName\s\\.{0,1000}/ nocase ascii wide
        ...
        $string9 = /.{0,1000}Clear\-RecycleBin\s\-Force\s\-ErrorAction\sSilentlyContinue.{0,1000}/ nocase ascii wide
        ...
        $string10 = /.{0,1000}Find\-LocalAdminAccess\s\-Verbose.{0,1000}/ nocase ascii wide
        // Description: alternativeto whoami
        // Reference: N/A
        $string11 = /.{0,1000}gci\senv:USERNAME.{0,1000}/ nocase ascii wide
        ...
        $string12 = /.{0,1000}gci\s\-h\sC:\\pagefile\.sys.{0,1000}/ nocase ascii wide
        // Description: AppLocker Get AppLocker policy
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string13 = /.{0,1000}Get\-AppLockerPolicy\s\-Effective\s.{0,1000}/ nocase ascii wide
        // Description: Powerview Enumerate users
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string14 = /.{0,1000}Get\-DomainUser\s\-KerberosPreuthNotRequired\s\-Verbose.{0,1000}/ nocase ascii wide
        // Description: PowerView get Locally logged users on a machine
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string15 = /.{0,1000}Get\-LoggedonLocal\s\-ComputerName\s.{0,1000}/ nocase ascii wide
        ...
        $string16 = /.{0,1000}Get\-MpComputerStatus.{0,1000}/ nocase ascii wide
        ...
        // Reference: N/A
        $string17 = /.{0,1000}Get\-NetGroupMember\s\-GroupName\s.{0,1000}DNSAdmins.{0,1000}/ nocase ascii wide
        // Description: PowerView Find users with SPN
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string18 = /.{0,1000}Get\-NetUser\s\-SPN.{0,1000}/ nocase ascii wide
        // Description: Find local admins on the domain machines
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string19 = /.{0,1000}Invoke\-EnumerateLocalAdmin\s\-Verbose.{0,1000}/ nocase ascii wide
        // Description: Check local admin access for the current user where the targets are found
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string20 = /.{0,1000}Invoke\-UserHunter\s\-CheckAccess.{0,1000}/ nocase ascii wide
        // Description: C2 server to connect to a victim machine via reverse shell
        // Reference: https://github.com/reveng007/C2_Server
        $string21 = /.{0,1000}Invoke\-WebRequest\sifconfig\.me\/ip.{0,1000}Content\.Trim\(\)/ nocase ascii wide
        // Description: alternativeto whoami
        // Reference: N/A
        $string22 = /.{0,1000}ls\senv:USERNAME.{0,1000}/ nocase ascii wide
        ...
        $string23 = /.{0,1000}New\-Object\sSystem\.Net\.Sockets\.TCPClient\(.{0,1000}\$stream\s\=\s\$client\.GetStream\(\).{0,1000}\[byte\[\]\]\$bytes\s\=\s0\.\.65535.{0,1000}/ nocase ascii wide
        ...
        $string24 = /.{0,1000}powershell\s\-c\s.{0,1000}\\windows\\system32\\inetsrv\\appcmd\.exe\slist\sapppool\s\/\@t:.{0,1000}/ nocase ascii wide
        ...
        // Reference: N/A
        $string25 = /.{0,1000}powershell\sNew\-ItemProperty\s\-Path\s.{0,1000}HKLM:\\SOFTWARE\\Policies\\Microsoft\\Windows\sDefender.{0,1000}\s\-Name\sDisableAntiSpyware\s\-Value\s1\s\-PropertyType\sDWORD\s\-Force.{0,1000}/ nocase ascii wide
        ...
        $string26 = /.{0,1000}powershell.{0,1000}Uninstall\-WindowsFeature\s\-Name\sWindows\-Defender\-GUI.{0,1000}/ nocase ascii wide
        // Description: Adversaries may attempt to execute powershell script from known accessible location
        // Reference: N/A
        $string27 = /.{0,1000}Powershell\.exe\s\s\-windowstyle\shidden\s\-nop\s\-ExecutionPolicy\sBypass\s\s\-Commmand\s.{0,1000}C:\\Users\\.{0,1000}\\AppData\\Roaming\\.{0,1000}/ nocase ascii wide
        ...
        $string28 = /.{0,1000}powershell\.exe\s\-exec\sbypass\s\-noni\s\-nop\s\-w\s1\s\-C.{0,1000}/ nocase ascii wide
        // Description: command pattern used by crackmapexec by default A swiss army knife for pentesting networks
        // Reference: https://github.com/byt3bl33d3r/CrackMapExec
        $string29 = /.{0,1000}powershell\.exe\s\-noni\s\-nop\s\-w\s1\s\-enc\s.{0,1000}/ nocase ascii wide
        // Description: list AV products with powershell
        // Reference: N/A
        $string30 = /.{0,1000}root\/SecurityCenter2.{0,1000}\s\-ClassName\sAntiVirusProduct.{0,1000}/ nocase ascii wide
        // Description: Disable scanning all downloaded files and attachments
        // Reference: N/A
        $string31 = /.{0,1000}Set\-MpPreference\s\-DisableIOAVProtection\s\$true.{0,1000}/ nocase ascii wide
        // Description: Defense evasion technique In order to avoid detection at any point of the kill chain. attackers use several ways to disable anti-virus. disable Microsoft firewall and clear logs.
        // Reference: N/A
        $string32 = /.{0,1000}Set\-MpPreference\s\-DisableRealtimeMonitoring\s\$true.{0,1000}/ nocase ascii wide
        // Description: Disable AMSI (set to 0 to enable)
        // Reference: N/A
        $string33 = /.{0,1000}Set\-MpPreference\s\-DisableScriptScanning\s1\s.{0,1000}/ nocase ascii wide
        // Description: alternativeto whoami
        // Reference: N/A
        $string34 = /\[Environment\]::UserName.{0,1000}/ nocase ascii wide
        // Description: Jenkins Abuse Without admin access
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string35 = /cmd\.exe\s\/c\sPowerShell\.exe\s\-Exec\sByPass\s\-Nol\s\-Enc\s.{0,1000}/ nocase ascii wide
        ...
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string37 = /Get\-ADGroup\s\-Filter\s.{0,1000}Name\s\-like\s.{0,1000}admin.{0,1000}/ nocase ascii wide
        // Description: AD Module Enumerate principals with Constrained Delegation enabled
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string38 = /Get\-ADObject\s\-Filter\s{msDS\-AllowedToDelegateTo\s.{0,1000}\s\-Properties\smsDS\-AllowedToDelegateTo.{0,1000}/ nocase ascii wide
        // Description: Enumerate shadow security principals mapped to a high priv group
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string39 = /Get\-ADObject\s\-SearchBase\s.{0,1000}CN\=Shadow\sPrincipal\sConfiguration.{0,1000}CN\=Services.{0,1000}\s\(Get\-ADRootDSE\)\.configurationNamingContext\)\s\|\sselect\s.{0,1000}msDS\-ShadowPrincipalSid.{0,1000}/ nocase ascii wide
        ...
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string45 = /Get\-NetGroup\s\-FullData.{0,1000}/ nocase ascii wide
        // Description: AD module Logon Script from remote IP
        // Reference: https://hideandsec.sh/books/cheatsheets-82c/page/active-directory
        $string46 = /Set\-ADObject\s\-SamAccountName\s.{0,1000}\s\-PropertyName\sscriptpath\s\-PropertyValue\s.{0,1000}\\.{0,1000}\.exe.{0,1000}/ nocase ascii wide
