rule File_Tunnel
{
    ...
    strings:
        ...
        $string1 = /\s\-\-read\s.{0,100}\\\\.{0,100}\s\-\-tcp\-connect\s127\.0\.0\.1\:.{0,100}\s\-\-write\s/ nocase ascii wide
        // Description: Tunnel TCP connections through a file
        // Reference: https://github.com/fiddyschmitt/File-Tunnel
        $string2 = /\s\-\-tcp\-listen\s127\.0\.0\.1\:.{0,100}\s\-\-write\s.{0,100}\s\-\-read\s/ nocase ascii wide
        // Description: Tunnel TCP connections through a file
        // Reference: https://github.com/fiddyschmitt/File-Tunnel
