rule powershell
{
    ...
    strings:
        ...
        $string25 = /http\:\/\/.{0,100}Microsoft\.ActiveDirectory\.Management\.dll/ nocase ascii wide
        // Description: redteam technique - import the ActiveDirectory module without the need to install it on the current computer - the dll has been extracted from a Windows 10 x64 with RSAT installed
        // Reference: https://github.com/mthcht/Purpleteam/blob/main/Simulation/Windows/ActiveDirectory/Bruteforce.ps1
        $string26 = /https\:\/\/.{0,100}Microsoft\.ActiveDirectory\.Management\.dll/ nocase ascii wide
        // Description: redteam technique - import the ActiveDirectory module without the need to install it on the current computer - the dll has been extracted from a Windows 10 x64 with RSAT installed
        // Reference: https://github.com/mthcht/Purpleteam/blob/main/Simulation/Windows/ActiveDirectory/Bruteforce.ps1
        $string27 = /Import\-Module\s.{0,100}Microsoft\.ActiveDirectory\.Management\.dll/ nocase ascii wide
        ...
        // Reference: N/A
        $string30 = /New\-ItemProperty\s.{0,100}\s\\"EnableModuleLogging\\"\s\-PropertyType\sDWord\s\-Value\s0/ nocase ascii wide
        // Description: disable powershell logging
        // Reference: N/A
        $string31 = /New\-ItemProperty\s.{0,100}\s\\"EnableScriptBlockLogging\\"\s\-PropertyType\sDWord\s\-Value\s0/ nocase ascii wide
        ...
        $string32 = /powershell\.exe\s\-nop\s\-c\s\\"start\-job\s.{0,100}Import\-Module\sBitsTransfer.{0,100}\$env\:temp.{0,100}GetRandomFileName\(\).{0,100}Start\-BitsTransfer\s\-Source\s\'http.{0,100}Remove\-Item.{0,100}Receive\-Job/ nocase ascii wide
        // Description: disable powershell logging
        // Reference: N/A
        $string33 = /reg\sadd\s.{0,100}\sEnableModuleLogging\s\/t\sREG_DWORD\s\/d\s0/ nocase ascii wide
        // Description: disable powershell logging
        // Reference: N/A
        $string34 = /reg\sadd\s.{0,100}\sEnableScriptBlockLogging\s\/t\sREG_DWORD\s\/d\s0/ nocase ascii wide
        ...
        $string36 = /Remove\-ItemProperty\s.{0,100}HKLM\:\\SOFTWARE\\YourSoftware\\Schedule\\TaskCache\\Tree\\.{0,100}\s\-Name\s.{0,100}SD/ nocase ascii wide
        ...
        // Description: disable powershell logging
        // Reference: N/A
        $string40 = /Set\-ItemProperty\s.{0,100}\s\\"EnableModuleLogging\\"\s\-Value\s0/ nocase ascii wide
        // Description: disable powershell logging
        // Reference: N/A
        $string41 = /Set\-ItemProperty\s.{0,100}\s\\"EnableScriptBlockLogging\\"\s\-Value\s0/ nocase ascii wide
        // Description: disable powershell logging
        // Reference: N/A
        ...
        // Description: Windows Defender evasion add an exclusion directory for your shady stuff
        // Reference: https://casvancooten.com/posts/2020/11/windows-active-directory-exploitation-cheat-sheet-and-command-reference
        $string43 = /Set\-MpPreference\s\-ExclusionPath\s.{0,100}\s\-DisableRealtimeMonitoring/ nocase ascii wide
        // Description: removing powershell console logging to avoid detection
        // Reference: N/A
