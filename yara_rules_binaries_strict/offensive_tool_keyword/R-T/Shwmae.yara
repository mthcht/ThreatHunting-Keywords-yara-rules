rule Shwmae
{
    ...
    strings:
        ...
        $string1 = /\\"author\\"\:\s\\"\@_EthicalChaos_\\"/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        ...
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string17 = /Forwards\sWebAuthn\sassertion\srequests\sto\sa\scompromised\shost\srunning\sthe\sShwmae\sWindows\sHello\sabuse\stool/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string18 = /ijacbjjjpmhencpkoghphdgbooifplmn/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string19 = /Shwmae\sdump\s/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string20 = /Shwmae\senum\s/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string21 = /Shwmae\sprt\s/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string22 = /Shwmae\sprt\s/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string23 = /Shwmae\ssign\s/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string24 = /Shwmae\swebauthn\s/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string25 = /Shwmae\swebauthn/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string26 = /Shwmae\.exe\ssign/ nocase ascii wide
        // Description: Shwmae is a tool focused on Windows Hello and DPAPI exploitation. It enables the enumeration - extraction and manipulation of Windows Hello keys and credentials
        // Reference: https://github.com/CCob/Shwmae
        $string27 = /WebAuthn\sproxy\srunning/ nocase ascii wide
