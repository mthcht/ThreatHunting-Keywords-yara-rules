rule jprq
{
    ...
    strings:
        ...
        // Description: expose TCP protocols such as HTTP - SSH etc. Any server!
        // Reference: https://github.com/azimjohn/jprq
        $string18 = ">jprq - join public router" nocase ascii wide
        // Description: expose TCP protocols such as HTTP - SSH etc. Any server!
        // Reference: https://github.com/azimjohn/jprq
        ...
        // Description: expose TCP protocols such as HTTP - SSH etc. Any server!
        // Reference: https://github.com/azimjohn/jprq
        $string52 = "JPRQ - The Tunneling Service" nocase ascii wide
        // Description: expose TCP protocols such as HTTP - SSH etc. Any server!
        // Reference: https://github.com/azimjohn/jprq
        $string53 = "jprq is successfully installed" nocase ascii wide
        // Description: expose TCP protocols such as HTTP - SSH etc. Any server!
        // Reference: https://github.com/azimjohn/jprq
