rule ComodoRMM__Itarian_RMM_
{
    ...
    strings:
        ...
        // Description: Comodo offers IT Remote Management tools includes RMM Software - Remote Access - Service Desk - Patch Management and Network Assessment (Itarian RMM)
        // Reference: https://one.comodo.com/
        $string3 = /\/tmp\/.{0,100}\/enroll\.sh/ nocase ascii wide
        // Description: Comodo offers IT Remote Management tools includes RMM Software - Remote Access - Service Desk - Patch Management and Network Assessment (Itarian RMM)
        // Reference: https://one.comodo.com/
        $string4 = /\/tmp\/.{0,100}\/itsm\.service/ nocase ascii wide
        // Description: Comodo offers IT Remote Management tools includes RMM Software - Remote Access - Service Desk - Patch Management and Network Assessment (Itarian RMM)
        // Reference: https://one.comodo.com/
        $string5 = /\/tmp\/.{0,100}\/itsm\-linux/ nocase ascii wide
        // Description: Comodo offers IT Remote Management tools includes RMM Software - Remote Access - Service Desk - Patch Management and Network Assessment (Itarian RMM)
        // Reference: https://one.comodo.com/
        ...
        // Description: Comodo offers IT Remote Management tools includes RMM Software - Remote Access - Service Desk - Patch Management and Network Assessment (Itarian RMM)
        // Reference: https://one.comodo.com/
        $string34 = /Linux\sITSM\sAgent\/.{0,100}\s\-e\s\/tmp\/install\.sh\s/ nocase ascii wide
        // Description: Comodo offers IT Remote Management tools includes RMM Software - Remote Access - Service Desk - Patch Management and Network Assessment (Itarian RMM)
        // Reference: https://one.comodo.com/
