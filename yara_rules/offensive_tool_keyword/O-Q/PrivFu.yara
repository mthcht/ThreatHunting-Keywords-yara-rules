rule PrivFu
{
    ...
    strings:
        ...
        // Description: Kernel Mode WinDbg extension for token privilege edit
        // Reference: https://github.com/daem0nc0re/PrivFu
        $string183 = "PrivEditor - Kernel Mode WinDbg extension for token privilege edit" nocase ascii wide
        // Description: Kernel mode WinDbg extension and PoCs for token privilege investigation.
        // Reference: https://github.com/daem0nc0re/PrivFu
        ...
        // Description: manage user right without secpol.msc
        // Reference: https://github.com/daem0nc0re/PrivFu
        $string193 = "S4Util - Help for \"enum\" command" nocase ascii wide
        // Description: PoCs for sensitive token privileges such SeDebugPrivilege
        // Reference: https://github.com/daem0nc0re/PrivFu
        ...
        // Description: SeTcbPrivilege exploitation
        // Reference: https://github.com/daem0nc0re/PrivFu/
        $string198 = "ServiceShell - PoC to create Service Logon process" nocase ascii wide
        // Description: SeTcbPrivilege exploitation
        // Reference: https://github.com/daem0nc0re/PrivFu/
        $string199 = "ServiceShell - PoC to create Service Logon process" nocase ascii wide
        // Description: PoCs for sensitive token privileges such SeDebugPrivilege
        // Reference: https://github.com/daem0nc0re/PrivFu
        ...
        // Description: SeTcbPrivilege exploitation
        // Reference: https://github.com/daem0nc0re/PrivFu/
        $string215 = "VirtualShell - PoC to create virtual account process" nocase ascii wide
        // Description: Kernel mode WinDbg extension and PoCs for token privilege investigation.
        // Reference: https://github.com/daem0nc0re/PrivFu
