rule InvisibilityCloak
{
    ...
    strings:
        ...
        $string1 = /\s\-d\s.{0,100}\s\-n\s.{0,100}\s\-m\sreverse.{0,100}\=/ nocase ascii wide
        // Description: Proof-of-concept obfuscation toolkit for C# post-exploitation tools
        // Reference: https://github.com/h4wkst3r/InvisibilityCloak
        $string2 = /\s\-d\s.{0,100}\s\-n\s.{0,100}\s\-m\srot13/ nocase ascii wide
        // Description: Proof-of-concept obfuscation toolkit for C# post-exploitation tools
        // Reference: https://github.com/h4wkst3r/InvisibilityCloak
        $string3 = /\s\-n\s.{0,100}TotallyLegitTool/ nocase ascii wide
        // Description: Proof-of-concept obfuscation toolkit for C# post-exploitation tools
        // Reference: https://github.com/h4wkst3r/InvisibilityCloak
