rule Spray365
{
    ...
    strings:
        ...
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        $string2 = /\sgenerate\saudit\s\-ep\s.*\-\-passwords_in_userfile/ nocase ascii wide
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        $string3 = /\sgenerate\snormal\s\-ep\s.*\s\-d\s.*\s\-u\s.*\s\-pf\s/ nocase ascii wide
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        ...
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        $string13 = /spray365_results_.*\.json/ nocase ascii wide
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        $string14 = /\-\-user_file.*\-\-password_file/ nocase ascii wide
