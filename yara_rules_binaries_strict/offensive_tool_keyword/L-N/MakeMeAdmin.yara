rule MakeMeAdmin
{
    ...
    strings:
        ...
        $string1 = /\/MakeMeAdmin\s.{0,100}\sx64\.msi/ nocase ascii wide
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        ...
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        $string4 = /\/MakeMeAdmin\/tree\/v.{0,100}\/Installers/ nocase ascii wide
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        $string5 = "/MakeMeAdmin/zipball" nocase ascii wide
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        $string6 = /\\MakeMeAdmin\s.{0,100}\sx64\sDebug\.msi/ nocase ascii wide
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        $string7 = /\\MakeMeAdmin\s.{0,100}\sx64\.msi/ nocase ascii wide
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        ...
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        $string13 = ">Make Me Admin<" nocase ascii wide
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        ...
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        $string43 = /net\.pipe\:\/\/.{0,100}\/MakeMeAdmin\/Service\\"/ nocase ascii wide
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        $string44 = /net\.tcp\:\/\/.{0,100}\/MakeMeAdmin\/Service/ nocase ascii wide
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        ...
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
        $string47 = "ServiceName = \"MakeMeAdmin\"" nocase ascii wide
        // Description: Enables users to elevate themselves to administrator-level rights
        // Reference: https://github.com/pseymour/MakeMeAdmin
