rule ProxyShell
{
    ...
    strings:
        ...
        $string1 = /New\-MailBoxExportRequest\s\-Mailbox\s.{0,100}\@.{0,100}\s\-FilePath\s.{0,100}\.aspx/ nocase ascii wide
        // Description: Microsoft Exchange Servers exploits - ProxyLogon and ProxyShell  CVE-2021-27065 CVE-2021-34473 CVE-2021-34523 CVE-2021-31207
        // Reference: https://www.cert.ssi.gouv.fr/uploads/ANSSI_TLPWHITE_ProxyShell_ProxyLogon_Sigma_yml.txt
        $string2 = /Set\-OabVirtualDirectory\s\-ExternalUrl\s\'http.{0,100}\:\/\/.{0,100}function\sPage_Load\(\)\{.{0,100}\}\<\/script\>/ nocase ascii wide
