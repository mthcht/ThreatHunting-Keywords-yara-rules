rule PSAmsi
{
    ...
    strings:
        ...
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string26 = /Find\-AmsiAstSignatures\s/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string27 = /Find\-AmsiPSTokenSignatures\s/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string28 = /Find\-AmsiSignatures\.ps1/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string29 = /Get\-MinimallyObfuscated\s\-ScriptPath\s/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string30 = /Get\-PSAmsiScanResult\s/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string31 = /Invoke\-PSAmsiScan/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string32 = /New\-PSAmsiScanner\s\-/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        ...
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string40 = /Reset\-PSAmsiScanCache\s/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string41 = /Start\-PSAmsiClient\.ps1/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string42 = /Start\-PSAmsiServer\s\-/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string43 = /Start\-PSAmsiServer\.ps1/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string44 = /Test\-ContainsAmsiAstSignatures\s/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string45 = /Test\-ContainsAmsiPSTokenSignatures\s\-/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
        $string46 = /Test\-ContainsAmsiSignatures\s/ nocase ascii wide
        // Description: PSAmsi is a tool for auditing and defeating AMSI signatures.
        // Reference: https://github.com/cobbr/PSAmsi
