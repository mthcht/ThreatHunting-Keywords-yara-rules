rule ntdsutil
{
    ...
    strings:
        ...
        // Reference: N/A
        $string2 = "ntdsutil \"ac in ntds\" roles" nocase ascii wide
        // Description: An attacker could use this to revert changes in AD for persistence
        // Reference: N/A
        $string3 = "ntdsutil \"activate instance ntds\" authoritative restore" nocase ascii wide
        // Description: creating a full backup of the Active Directory database and saving it to the \temp directory
        // Reference: N/A
