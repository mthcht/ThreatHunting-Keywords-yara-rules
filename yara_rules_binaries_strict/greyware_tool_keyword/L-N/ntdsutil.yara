rule ntdsutil
{
    ...
    strings:
        ...
        // Description: creating a full backup of the Active Directory database 
        // Reference: N/A
        $string2 = /ac\si\sntds.{0,100}\s.{0,100}create\sfull/ nocase ascii wide
        ...
        // Description: creating a full backup of the Active Directory database and saving it to the \temp directory
        // Reference: N/A
        $string11 = /ntdsutil\.exe\s.{0,100}ac\si\sntds.{0,100}\s.{0,100}ifm.{0,100}\s.{0,100}create\sfull\s.{0,100}c\:\\ProgramData/ nocase ascii wide
        // Description: creating a full backup of the Active Directory database and saving it to the \temp directory
        // Reference: N/A
        $string12 = /ntdsutil\.exe\s.{0,100}ac\si\sntds.{0,100}\s.{0,100}ifm.{0,100}\s.{0,100}create\sfull\s.{0,100}users\\public/ nocase ascii wide
        // Description: creating a full backup of the Active Directory database and saving it to the \temp directory
        // Reference: N/A
        $string13 = /ntdsutil\.exe\s.{0,100}ac\si\sntds.{0,100}ifm.{0,100}create\sfull\s.{0,100}temp/ nocase ascii wide
        // Description: creating a full backup of the Active Directory database and saving it to the \temp directory
        // Reference: N/A
        $string14 = /The\sdatabase\sengine\screated\sa\snew\sdatabase.{0,100}temp\\Active\sDirectory\\ntds\.dit/ nocase ascii wide
