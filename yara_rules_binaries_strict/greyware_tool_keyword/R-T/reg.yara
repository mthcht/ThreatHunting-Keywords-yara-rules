rule reg
{
    ...
    strings:
        ...
        // Description: the commands are used to export the SAM and SYSTEM registry hives which contain sensitive Windows security data including hashed passwords for local accounts. By obtaining these hives an attacker can attempt to crack the hashes or use them in pass-the-hash attacks for unauthorized access.
        // Reference: N/A
        $string11 = /copy\s.{0,100}system\.hive\s\\\\/ nocase ascii wide
        ...
        $string12 = /HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Policies\\System.{0,100}\s\/v\sEnableLUA\s\/t\sREG_DWORD\s\/d\s0\s\/f/ nocase ascii wide
        ...
        // Reference: N/A
        $string31 = /reg\sadd\s\\"HKLM\\Software\\Microsoft\\Windows\sNT\\CurrentVersion\\Winlogon\\SpecialAccounts\\Userlist\\"\s\/v\s.{0,100}\s\/t\sREG_DWORD\s\/d\s0/ nocase ascii wide
        ...
        // Reference: N/A
        $string67 = /reg\sadd\s.{0,100}HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\Terminal\sServer.{0,100}\s\/v\sfDenyTSConnections\s\/t\sREG_DWORD\s\/d\s0\s\/f/ nocase ascii wide
        // Description: Hit F5 a bunch of times when you are at the RDP login screen
        // Reference: N/A
        $string68 = /REG\sADD\s.{0,100}HKLM\\SOFTWARE\\Microsoft\\Windows\sNT\\CurrentVersion\\Image\sFile\sExecution\sOptions\\sethc\.exe.{0,100}\s\/t\sREG_SZ\s\/v\sDebugger\s\/d\s.{0,100}\\windows\\system32\\cmd\.exe.{0,100}\s\/f/ nocase ascii wide
        // Description: At the login screen press Windows Key+U and you get a cmd.exe window as SYSTEM.
        // Reference: N/A
        $string69 = /REG\sADD\s.{0,100}HKLM\\SOFTWARE\\Microsoft\\Windows\sNT\\CurrentVersion\\Image\sFile\sExecution\sOptions\\utilman\.exe.{0,100}\s\/t\sREG_SZ\s\/v\sDebugger\s\/d\s.{0,100}\\windows\\system32\\cmd\.exe.{0,100}\s\/f/ nocase ascii wide
        // Description: Defense evasion technique disable windows defender
        // Reference: N/A
        $string70 = /reg\sadd\s.{0,100}HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\sDefender\\".{0,100}\s\/v\sDisableAntiSpyware\s\/t\sREG_DWORD\s\/d\s1\s\/f/ nocase ascii wide
        // Description: Disable Real Time Protection
        // Reference: N/A
        $string71 = /reg\sadd\s.{0,100}HKLM\\Software\\Policies\\Microsoft\\Windows\sDefender\\".{0,100}\/v\s.{0,100}DisableAntiSpyware.{0,100}\s\/t\sREG_DWORD\s\/d\s.{0,100}1.{0,100}\s\/f/ nocase ascii wide
        // Description: Disable Real Time Protection
        // Reference: N/A
        $string72 = /reg\sadd\s.{0,100}HKLM\\Software\\Policies\\Microsoft\\Windows\sDefender.{0,100}\s\/v\s.{0,100}DisableAntiVirus.{0,100}\s\/t\sREG_DWORD\s\/d\s.{0,100}1.{0,100}\s\/f/ nocase ascii wide
        ...
        // Reference: N/A
        $string73 = /reg\sadd\s.{0,100}HKLM\\Software\\Policies\\Microsoft\\Windows\sDefender.{0,100}\s\/v\sDisable.{0,100}\s\/t\sREG_DWORD\s\/d\s1\s\/f/ nocase ascii wide
        ...
        $string74 = /reg\sadd\s.{0,100}HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\sDefender\\Threats\\ThreatIDDefaultAction/ nocase ascii wide
        ...
        $string75 = /reg\sadd\s.{0,100}HKLM\\SYSTEM\\CurrentControlSet\\Control\\Session\sManager\\Memory\sManagement\\PrefetchParameters.{0,100}\s\/v\sEnablePrefetcher\s\/t\sREG_DWORD\s\/f\s\/d\s0/ nocase ascii wide
        // Description: Blind ETW Windows Defender: zero out registry values corresponding to its ETW sessions
        // Reference: N/A
        $string76 = /reg\sadd\s.{0,100}HKLM\\System\\CurrentControlSet\\Control\\WMI\\Autologger\\DefenderApiLogger.{0,100}\s\/v\s.{0,100}Start.{0,100}\s\/t\sREG_DWORD\s\/d\s.{0,100}0.{0,100}\s\/f/ nocase ascii wide
        // Description: Disable Windows Defender Security Center
        // Reference: N/A
        $string77 = /reg\sadd\s.{0,100}HKLM\\System\\CurrentControlSet\\Services\\SecurityHealthService.{0,100}\s\/v\s.{0,100}Start.{0,100}\s\/t\sREG_DWORD\s\/d\s.{0,100}4.{0,100}\s\/f/ nocase ascii wide
        ...
        // Reference: https://thedfirreport.com/2024/08/12/threat-actors-toolkit-leveraging-sliver-poshc2-batch-scripts/#c01
        $string85 = /reg\sdelete\s\\"HKCR\\.{0,100}\\shellex\\ContextMenuHandlers\\EPP\\"\s\/f/ nocase ascii wide
        // Description: remove the Windows Defender context menu options
        // Reference: https://thedfirreport.com/2024/08/12/threat-actors-toolkit-leveraging-sliver-poshc2-batch-scripts/#c01
        ...
        // Description: Disable Real Time Protection
        // Reference: N/A
        $string120 = /reg\sdelete\s.{0,100}HKLM\\Software\\Policies\\Microsoft\\Windows\sDefender.{0,100}\s\/f/ nocase ascii wide
        ...
        // Description: commands from wmiexec2.0 -  is the same wmiexec that everyone knows and loves (debatable). This 2.0 version is obfuscated to avoid well known signatures from various AV engines.
        // Reference: https://github.com/ice-wzl/wmiexec2
        $string142 = /reg\ssave\s\\"HK.{0,100}L.{0,100}M\\s.{0,100}ec.{0,100}u.{0,100}rit.{0,100}y.{0,100}\\"\supdate\.exe/ nocase ascii wide
        // Description: saves a copy of the registry hive hklm\sam to a .dat file
        // Reference: https://media.defense.gov/2023/May/24/2003229517/-1/-1/0/CSA_Living_off_the_Land.PDF
        $string143 = /reg\ssave\shklm\\sam\s.{0,100}\.dat/ nocase ascii wide
        // Description: the commands are used to export the SAM and SYSTEM registry hives which contain sensitive Windows security data including hashed passwords for local accounts. By obtaining these hives an attacker can attempt to crack the hashes or use them in pass-the-hash attacks for unauthorized access.
        // Reference: N/A
        $string144 = /reg\ssave\sHKLM\\SAM\s.{0,100}c\:/ nocase ascii wide
        // Description: the commands are used to export the SAM and SYSTEM registry hives which contain sensitive Windows security data including hashed passwords for local accounts. By obtaining these hives an attacker can attempt to crack the hashes or use them in pass-the-hash attacks for unauthorized access.
        // Reference: N/A
        ...
        // Reference: https://media.defense.gov/2023/May/24/2003229517/-1/-1/0/CSA_Living_off_the_Land.PDF
        $string147 = /reg\ssave\shklm\\system\s.{0,100}\.dat/ nocase ascii wide
        // Description: the commands are used to export the SAM and SYSTEM registry hives which contain sensitive Windows security data including hashed passwords for local accounts. By obtaining these hives an attacker can attempt to crack the hashes or use them in pass-the-hash attacks for unauthorized access.
        // Reference: N/A
        $string148 = /reg\ssave\sHKLM\\SYSTEM\s.{0,100}c\:/ nocase ascii wide
        // Description: the commands are used to export the SAM and SYSTEM registry hives which contain sensitive Windows security data including hashed passwords for local accounts. By obtaining these hives an attacker can attempt to crack the hashes or use them in pass-the-hash attacks for unauthorized access.
        // Reference: N/A
        $string149 = /reg\ssave\shklm\\system\ssystem/ nocase ascii wide
        // Description: Windows Defender Tampering Via registry
        // Reference: https://www.virustotal.com/gui/file/00820a1f0972678cfe7885bc989ab3e5602b0febc96baf9bf3741d56aa374f03/behavior
        $string150 = /reg\.exe\sadd\s.{0,100}HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\sDefender\\Threats\\ThreatIDDefaultAction/ nocase ascii wide
