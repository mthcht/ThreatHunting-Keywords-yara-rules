rule UsoDllLoader
{
    ...
    strings:
        ...
        $string1 = /.{0,1000}2D863D7A\-A369\-419C\-B4B3\-54BDB88B5816.{0,1000}/ nocase ascii wide
        // Description: This PoC shows a technique that can be used to weaponize privileged file write vulnerabilities on Windows. It provides an alternative to the DiagHub DLL loading exploit 
        // Reference: https://github.com/itm4n/UsoDllLoader
        $string2 = /.{0,1000}tcpClient\.connectTCP\(.{0,1000}127\.0\.0\.1.{0,1000}1337.{0,1000}/ nocase ascii wide
        // Description: This PoC shows a technique that can be used to weaponize privileged file write vulnerabilities on Windows. It provides an alternative to the DiagHub DLL loading exploit 
        // Reference: https://github.com/itm4n/UsoDllLoader
        $string3 = /.{0,1000}UsoDllLoader.{0,1000}/ nocase ascii wide
