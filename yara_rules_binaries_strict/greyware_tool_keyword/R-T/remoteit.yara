rule remoteit
{
    ...
    strings:
        ...
        // Description: Expose localhost to internet
        // Reference: https://github.com/remoteit/installer
        $string326 = "systemctl enable connectd" nocase ascii wide
        // Description: Expose localhost to internet
        // Reference: https://github.com/remoteit/installer
        $string327 = "systemctl start connectd_schannel" nocase ascii wide
        // Description: Expose localhost to internet
        // Reference: https://github.com/remoteit/installer
        $string328 = "systemctl stop connectd_schannel" nocase ascii wide
