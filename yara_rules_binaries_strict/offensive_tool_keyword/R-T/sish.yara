rule sish
{
    ...
    strings:
        ...
        $string1 = " sish/deploy " nocase ascii wide
        // Description: An open source serveo/ngrok alternative. HTTP(S)/WS(S)/TCP Tunnels to localhost using only SSH
        // Reference: https://github.com/antoniomika/sish
        ...
        // Description: An open source serveo/ngrok alternative. HTTP(S)/WS(S)/TCP Tunnels to localhost using only SSH
        // Reference: https://github.com/antoniomika/sish
        $string50 = "docker run -itd --name sish" nocase ascii wide
        // Description: An open source serveo/ngrok alternative. HTTP(S)/WS(S)/TCP Tunnels to localhost using only SSH
        // Reference: https://github.com/antoniomika/sish
        ...
        // Description: An open source serveo/ngrok alternative. HTTP(S)/WS(S)/TCP Tunnels to localhost using only SSH
        // Reference: https://github.com/antoniomika/sish
        $string56 = /https\:\/\/.{0,100}\.tuns\.sh/ nocase ascii wide
        // Description: An open source serveo/ngrok alternative. HTTP(S)/WS(S)/TCP Tunnels to localhost using only SSH
        // Reference: https://github.com/antoniomika/sish
        ...
        // Description: An open source serveo/ngrok alternative. HTTP(S)/WS(S)/TCP Tunnels to localhost using only SSH
        // Reference: https://github.com/antoniomika/sish
        $string60 = /ssh\s\-p\s2222\s\-R\s.{0,100}\:80\:localhost\:8080\stuns\.sh/ nocase ascii wide
        // Description: An open source serveo/ngrok alternative. HTTP(S)/WS(S)/TCP Tunnels to localhost using only SSH
        // Reference: https://github.com/antoniomika/sish
