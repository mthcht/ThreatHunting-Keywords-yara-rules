rule telnet
{
    ...
    strings:
        ...
        $string1 = /.{0,1000}\&\&\stelnet\s.{0,1000}\s2\>\&1\s\<\/dev\/console.{0,1000}/ nocase ascii wide
        ...
        $string2 = /.{0,1000}telnet\s.{0,1000}\s\|\s\/bin\/bash\s\|\stelnet\s.{0,1000}/ nocase ascii wide
