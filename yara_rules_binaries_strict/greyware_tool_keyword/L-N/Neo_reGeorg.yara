rule Neo_reGeorg
{
    ...
    strings:
        ...
        // Description: Neo-reGeorg is a project that seeks to aggressively refactor reGeorg
        // Reference: https://github.com/L-codes/Neo-reGeorg
        $string2 = /\.py\s.{0,100}\-\-proxy\ssocks5\:\/\// nocase ascii wide
        // Description: Neo-reGeorg is a project that seeks to aggressively refactor reGeorg
        // Reference: https://github.com/L-codes/Neo-reGeorg
        ...
        // Description: Neo-reGeorg is a project that seeks to aggressively refactor reGeorg
        // Reference: https://github.com/L-codes/Neo-reGeorg
        $string70 = "NeoGeorg says, 'All seems fine'" nocase ascii wide
        // Description: Neo-reGeorg is a project that seeks to aggressively refactor reGeorg
        // Reference: https://github.com/L-codes/Neo-reGeorg
        $string71 = /neoreg\.py\sgenerate/ nocase ascii wide
        // Description: Neo-reGeorg is a project that seeks to aggressively refactor reGeorg
        // Reference: https://github.com/L-codes/Neo-reGeorg
        $string72 = /neoreg\.py\s\-k\s.{0,100}\s\-u\shttp.{0,100}\.php/ nocase ascii wide
