rule chimera
{
    ...
    strings:
        ...
        // Description: Chimera is a PowerShell obfuscation script designed to bypass AMSI and commercial antivirus solutions.
        // Reference: https://github.com/tokyoneon/Chimera/
        $string2 = /\s\-f\s.*\.ps1\s\-l\s3\s\-o\s.*\.ps1\s\-v\s\-t\spowershell.*reverse/ nocase ascii wide
        // Description: Chimera is a PowerShell obfuscation script designed to bypass AMSI and commercial antivirus solutions.
        // Reference: https://github.com/tokyoneon/Chimera/
        $string3 = /\s\-f\sshells\/generic1\.ps1\s/ nocase ascii wide
        // Description: Chimera is a PowerShell obfuscation script designed to bypass AMSI and commercial antivirus solutions.
        // Reference: https://github.com/tokyoneon/Chimera/
        $string4 = /\s\-s\s.*ascii.*\s\-b\s.*reverse.*invoke\-expression/ nocase ascii wide
        // Description: Chimera is a PowerShell obfuscation script designed to bypass AMSI and commercial antivirus solutions.
        // Reference: https://github.com/tokyoneon/Chimera/
        ...
        // Description: Chimera is a PowerShell obfuscation script designed to bypass AMSI and commercial antivirus solutions.
        // Reference: https://github.com/tokyoneon/Chimera/
        $string10 = /\/tmp\/vt\-post\-.*\.txt/ nocase ascii wide
        // Description: Chimera is a PowerShell obfuscation script designed to bypass AMSI and commercial antivirus solutions.
        // Reference: https://github.com/tokyoneon/Chimera/
        $string11 = /\/tmp\/vt\-results\-.*\.txt/ nocase ascii wide
        // Description: Chimera is a PowerShell obfuscation script designed to bypass AMSI and commercial antivirus solutions.
        // Reference: https://github.com/tokyoneon/Chimera/
