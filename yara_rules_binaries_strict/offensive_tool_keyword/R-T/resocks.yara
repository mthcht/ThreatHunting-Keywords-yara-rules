rule resocks
{
    ...
    strings:
        ...
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        $string2 = /\/resocks\s.{0,100}\s\-\-key\s/
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        ...
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        $string5 = /\/resocks_.{0,100}_Linux_x86_64\.tar\.gz/
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        ...
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        $string8 = /\/resocks_Linux_.{0,100}\.tar\.gz/
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        ...
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        $string27 = "export RESOCKS_KEY=" nocase ascii wide
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        ...
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        $string31 = "resocks generate" nocase ascii wide
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        $string32 = "resocks listen" nocase ascii wide
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        ...
        // Description: resocks is a reverse/back-connect SOCKS5 proxy tunnel that can be used to route traffic through a system that can't be directly accessed
        // Reference: https://github.com/RedTeamPentesting/resocks
        $string35 = "SOCKS5 server active" nocase ascii wide
