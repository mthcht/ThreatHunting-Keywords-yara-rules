rule octopus
{
    ...
    strings:
        ...
        // Description: Octopus is an open source. pre-operation C2 server based on python which can control an Octopus powershell agent through HTTP/S.
        // Reference: https://github.com/mhaskar/Octopus
        $string3 = /\.\/.*octopus\.py/ nocase ascii wide
        // Description: Octopus is an open source. pre-operation C2 server based on python which can control an Octopus powershell agent through HTTP/S.
        // Reference: https://github.com/mhaskar/Octopus
        ...
        // Description: Octopus is an open source. pre-operation C2 server based on python which can control an Octopus powershell agent through HTTP/S.
        // Reference: https://github.com/mhaskar/Octopus
        $string13 = /generate_unmanaged_exe\soperation1\s.*\.exe/ nocase ascii wide
        // Description: Octopus is an open source. pre-operation C2 server based on python which can control an Octopus powershell agent through HTTP/S.
        // Reference: https://github.com/mhaskar/Octopus
        ...
        // Description: Octopus is an open source. pre-operation C2 server based on python which can control an Octopus powershell agent through HTTP/S.
        // Reference: https://github.com/mhaskar/Octopus
        $string17 = /listen_http\s0\.0\.0\.0\s8080\s.*\.php\soperation1/ nocase ascii wide
        // Description: Octopus is an open source. pre-operation C2 server based on python which can control an Octopus powershell agent through HTTP/S.
        // Reference: https://github.com/mhaskar/Octopus
