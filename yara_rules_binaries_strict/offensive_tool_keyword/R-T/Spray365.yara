rule Spray365
{
    ...
    strings:
        ...
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        $string2 = /\sgenerate\saudit\s\-ep\s.{0,100}\-\-passwords_in_userfile/ nocase ascii wide
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        $string3 = /\sgenerate\snormal\s\-ep\s.{0,100}\s\-d\s.{0,100}\s\-u\s.{0,100}\s\-pf\s/ nocase ascii wide
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        ...
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        $string13 = /spray365_results_.{0,100}\.json/ nocase ascii wide
        // Description: Spray365 is a password spraying tool that identifies valid credentials for Microsoft accounts (Office 365 / Azure AD).
        // Reference: https://github.com/MarkoH17/Spray365
        $string14 = /\-\-user_file.{0,100}\-\-password_file/ nocase ascii wide
