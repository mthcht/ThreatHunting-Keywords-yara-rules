rule takeown
{
    ...
    strings:
        ...
        $string1 = /.{0,1000}takeown\s\/f\s\"C:\\windows\\system32\\config\\SAM\".{0,1000}/ nocase ascii wide
        ...
        $string2 = /.{0,1000}takeown\s\/f\sC:\\Windows\\System32\\amsi\.dll\s\/a.{0,1000}/ nocase ascii wide
