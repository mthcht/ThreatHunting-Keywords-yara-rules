rule chromium
{
    ...
    strings:
        ...
        $string1 = /brave.*\s\-\-headless\s.*\s\-\-dump\-dom\shttp/ nocase ascii wide
        ...
        $string2 = /brave\.exe.*\s\-\-load\-extension\=\".*\\Users\\.*\\Appdata\\Local\\Temp\\/ nocase ascii wide
        // Description: Headless Chromium allows running Chromium in a headless/server environment - downloading a file - abused by attackers
        // Reference: https://redcanary.com/blog/intelligence-insights-june-2023/
        $string3 = /chrome.*\s\-\-headless\s.*\s\-\-dump\-dom\shttp/ nocase ascii wide
        // Description: The --load-extension switch allows the source to specify a target directory to load as an extension. This gives malware the opportunity to start a new browser window with their malicious extension loaded.
        // Reference: https://www.mandiant.com/resources/blog/lnk-between-browsers
        $string4 = /chrome\.exe.*\s\-\-load\-extension\=\".*\\Users\\.*\\Appdata\\Local\\Temp\\/ nocase ascii wide
        // Description: Headless Chromium allows running Chromium in a headless/server environment - downloading a file - abused by attackers
        // Reference: https://redcanary.com/blog/intelligence-insights-june-2023/
        $string5 = /msedge.*\s\-\-headless\s.*\s\-\-dump\-dom\shttp/ nocase ascii wide
        ...
        $string6 = /msedge.*\s\-\-headless\s\-\-disable\-gpu\s\-\-remote\-debugging\-port\=/ nocase ascii wide
        // Description: The --load-extension switch allows the source to specify a target directory to load as an extension. This gives malware the opportunity to start a new browser window with their malicious extension loaded.
        // Reference: https://www.mandiant.com/resources/blog/lnk-between-browsers
        $string7 = /msedge\.exe.*\s\-\-load\-extension\=\".*\\Users\\.*\\Appdata\\Local\\Temp\\/ nocase ascii wide
        // Description: Headless Chromium allows running Chromium in a headless/server environment - downloading a file - abused by attackers
        // Reference: https://redcanary.com/blog/intelligence-insights-june-2023/
        $string8 = /opera.*\s\-\-headless\s.*\s\-\-dump\-dom\shttp/ nocase ascii wide
        // Description: The --load-extension switch allows the source to specify a target directory to load as an extension. This gives malware the opportunity to start a new browser window with their malicious extension loaded.
        // Reference: https://www.mandiant.com/resources/blog/lnk-between-browsers
        $string9 = /opera\.exe.*\s\-\-load\-extension\=\".*\\Users\\.*\\Appdata\\Local\\Temp\\/ nocase ascii wide
        // Description: Headless Chromium allows running Chromium in a headless/server environment - downloading a file - abused by attackers
        // Reference: https://redcanary.com/blog/intelligence-insights-june-2023/
        $string10 = /vivaldi.*\s\-\-headless\s.*\s\-\-dump\-dom\shttp/ nocase ascii wide
        // Description: The --load-extension switch allows the source to specify a target directory to load as an extension. This gives malware the opportunity to start a new browser window with their malicious extension loaded.
        // Reference: https://www.mandiant.com/resources/blog/lnk-between-browsers
        $string11 = /vivaldi\.exe.*\s\-\-load\-extension\=\".*\\Users\\.*\\Appdata\\Local\\Temp\\/ nocase ascii wide
