rule dnscrypt
{
    ...
    strings:
        ...
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
        $string26 = /dnscrypt\-proxy\-linux_arm\-.{0,1000}\.tar\.gz/
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
        $string27 = /dnscrypt\-proxy\-linux_arm64\-.{0,1000}\.tar\.gz/
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
        $string28 = /dnscrypt\-proxy\-linux_i386\-.{0,1000}\.tar\.gz/
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
        $string29 = /dnscrypt\-proxy\-linux_mips\-.{0,1000}\.tar\.gz/
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
        $string30 = /dnscrypt\-proxy\-linux_mips64\-.{0,1000}\.tar\.gz/
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
        $string31 = /dnscrypt\-proxy\-linux_mips64le\-.{0,1000}\.tar\.gz/
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
        $string32 = /dnscrypt\-proxy\-linux_mipsle\-.{0,1000}\.tar\.gz/
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
        $string33 = /dnscrypt\-proxy\-linux_riscv64\-.{0,1000}\.tar\.gz/
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
        $string34 = /dnscrypt\-proxy\-linux_x86_64\-.{0,1000}\.tar\.gz/
        // Description: A flexible DNS proxy with support for modern encrypted DNS protocols such as DNSCrypt v2 - DNS-over-HTTPS - Anonymized DNSCrypt and ODoH (Oblivious DoH).
        // Reference: https://github.com/DNSCrypt/dnscrypt-proxy
