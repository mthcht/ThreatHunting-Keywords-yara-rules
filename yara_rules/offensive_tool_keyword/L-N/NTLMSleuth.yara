rule NTLMSleuth
{
    ...
    strings:
        ...
        $string1 = /jmarr73\/NTLMSleuth/ nocase ascii wide
        // Description: verify NTLM hash integrity against the robust database of ntlm.pw.
        // Reference: https://github.com/jmarr73/NTLMSleuth
        $string2 = /\/NTLMSleuth\.git/ nocase ascii wide
        // Description: verify NTLM hash integrity against the robust database of ntlm.pw.
        // Reference: https://github.com/jmarr73/NTLMSleuth
        $string3 = /NTLMSleuth\.ps1/ nocase ascii wide
        // Description: verify NTLM hash integrity against the robust database of ntlm.pw.
        // Reference: https://github.com/jmarr73/NTLMSleuth
        $string4 = /NTLMSleuth\.sh/ nocase ascii wide
        // Description: verify NTLM hash integrity against the robust database of ntlm.pw.
        // Reference: https://github.com/jmarr73/NTLMSleuth
        $string5 = /https:\/\/ntlm\.pw\// nocase ascii wide
