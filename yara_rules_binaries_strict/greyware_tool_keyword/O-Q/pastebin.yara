rule pastebin
{
    ...
    strings:
        ...
        $string1 = /pastebin\.com.{0,100}\/raw\/.{0,100}\s/ nocase ascii wide
        // Description: pastebin raw access content - abused by malwares to retrieve payloads
        // Reference: pastebin.com
        $string2 = /pastebin\.com.{0,100}\/rw\// nocase ascii wide
        // Description: pastebin POST url - abused by malwares to exfiltrate informations
        // Reference: pastebin.com
        $string3 = /pastebin\.com.{0,100}api\/api_post\.php/ nocase ascii wide
