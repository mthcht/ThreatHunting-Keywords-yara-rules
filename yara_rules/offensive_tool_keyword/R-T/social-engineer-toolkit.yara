rule social_engineer_toolkit
{
    ...
    strings:
        ...
        $string1 = /.{0,1000}\ssetoolkit.{0,1000}/ nocase ascii wide
        // Description: The Social-Engineer Toolkit is an open-source penetration testing framework designed for social engineering. SET has a number of custom attack vectors that allow you to make a believable attack quickly. SET is a product of TrustedSec
        // Reference: https://github.com/trustedsec/social-engineer-toolkit
        $string2 = /.{0,1000}apt\sinstall\sset\s\-y.{0,1000}/ nocase ascii wide
        // Description: The Social-Engineer Toolkit is an open-source penetration testing framework designed for social engineering. SET has a number of custom attack vectors that allow you to make a believable attack quickly. SET is a product of TrustedSec
        // Reference: https://github.com/trustedsec/social-engineer-toolkit
        $string3 = /.{0,1000}bin\/setoolkit.{0,1000}/ nocase ascii wide
        // Description: The Social-Engineer Toolkit is an open-source penetration testing framework designed for social engineering. SET has a number of custom attack vectors that allow you to make a believable attack quickly. SET is a product of TrustedSec
        // Reference: https://github.com/trustedsec/social-engineer-toolkit
        $string4 = /.{0,1000}setoolkit\s.{0,1000}/ nocase ascii wide
        ...
        // Reference: https://github.com/trustedsec/social-engineer-toolkit
        $string5 = /.{0,1000}Social\sEngineer\sToolkit.{0,1000}/ nocase ascii wide
        // Description: The Social-Engineer Toolkit is an open-source penetration testing framework designed for social engineering. SET has a number of custom attack vectors that allow you to make a believable attack quickly. SET is a product of TrustedSec
        // Reference: https://github.com/trustedsec/social-engineer-toolkit
        $string6 = /.{0,1000}trustedsec\/social\-engineer\-toolkit.{0,1000}/ nocase ascii wide
