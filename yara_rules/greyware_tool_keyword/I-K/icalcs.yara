rule icalcs
{
    ...
    strings:
        ...
        $string1 = /.{0,1000}icacls\s\"C:\\windows\\system32\\config\\SAM\"\s\/grant.{0,1000}/ nocase ascii wide
        ...
        $string2 = /.{0,1000}icacls\.exe\sC:\\Windows\\System32\\amsi\.dll\s\/grant\sadministrators:F.{0,1000}/ nocase ascii wide
