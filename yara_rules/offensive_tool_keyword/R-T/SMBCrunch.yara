rule SMBCrunch
{
    ...
    strings:
        ...
        $string1 = /\s\-c\s.*\s\-s\s.*\s\-o\sshare_listing\s\-m\s150/ nocase ascii wide
        // Description: SMBCrunch allows a red teamer to quickly identify Windows File Shares in a network - performs a recursive directory listing of the provided shares  and can even grab a file from the remote share if it looks like a juicy target.
        // Reference: https://github.com/Raikia/SMBCrunch
        ...
        // Description: SMBCrunch allows a red teamer to quickly identify Windows File Shares in a network - performs a recursive directory listing of the provided shares  and can even grab a file from the remote share if it looks like a juicy target.
        // Reference: https://github.com/Raikia/SMBCrunch
        $string10 = /\/tmp\/smb_auth_temp_.*\.txt/ nocase ascii wide
        // Description: SMBCrunch allows a red teamer to quickly identify Windows File Shares in a network - performs a recursive directory listing of the provided shares  and can even grab a file from the remote share if it looks like a juicy target.
        // Reference: https://github.com/Raikia/SMBCrunch
        ...
        // Description: SMBCrunch allows a red teamer to quickly identify Windows File Shares in a network - performs a recursive directory listing of the provided shares  and can even grab a file from the remote share if it looks like a juicy target.
        // Reference: https://github.com/Raikia/SMBCrunch
        $string14 = /No\scredentials\ssupplied.*\slooking\sfor\snull\ssession\sshares\!/ nocase ascii wide
        // Description: SMBCrunch allows a red teamer to quickly identify Windows File Shares in a network - performs a recursive directory listing of the provided shares  and can even grab a file from the remote share if it looks like a juicy target.
        // Reference: https://github.com/Raikia/SMBCrunch
        ...
        // Description: SMBCrunch allows a red teamer to quickly identify Windows File Shares in a network - performs a recursive directory listing of the provided shares  and can even grab a file from the remote share if it looks like a juicy target.
        // Reference: https://github.com/Raikia/SMBCrunch
        $string17 = /smbclient\s\-N\s\-A\s.*\\\\\\\\.*\\\\.*temp_out\.txt/ nocase ascii wide
        // Description: SMBCrunch allows a red teamer to quickly identify Windows File Shares in a network - performs a recursive directory listing of the provided shares  and can even grab a file from the remote share if it looks like a juicy target.
        // Reference: https://github.com/Raikia/SMBCrunch
