rule rclone
{
    ...
    strings:
        ...
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        $string21 = ">Rsync for cloud storage<" nocase ascii wide
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        ...
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        $string1123 = "choco install rclone" nocase ascii wide
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        ...
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        $string1201 = "docker push rclone/" nocase ascii wide
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        ...
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        $string1374 = /rclone\s\scopy\s.{0,1000}\:/ nocase ascii wide
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        $string1375 = "rclone config" nocase ascii wide
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        $string1376 = /rclone\scopy\s.{0,1000}\:/ nocase ascii wide
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        ...
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        $string1386 = /rclone\.exe.{0,1000}\scopy\s.{0,1000}\:/ nocase ascii wide
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
        $string1387 = /rclone\.exe.{0,1000}\s\-l\s.{0,1000}\s.{0,1000}\:/ nocase ascii wide
        // Description: Rclone is a command line program for syncing files with cloud storage services - abused by a lot of ransomware groups
        // Reference: https://github.com/rclone/rclone
