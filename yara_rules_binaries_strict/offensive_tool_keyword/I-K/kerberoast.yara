rule kerberoast
{
    ...
    strings:
        ...
        // Description: Kerberoast is a series of tools for attacking MS Kerberos implementations
        // Reference: https://github.com/nidem/kerberoast
        $string12 = /kerberos\:\:ptt\s.{0,100}\.kirbi/ nocase ascii wide
        // Description: Kerberoast is a series of tools for attacking MS Kerberos implementations
        // Reference: https://github.com/nidem/kerberoast
        ...
        // Description: Kerberoast is a series of tools for attacking MS Kerberos implementations
        // Reference: https://github.com/nidem/kerberoast
        $string16 = /setspn\s\-T\smedin\s\-Q\s.{0,100}\// nocase ascii wide
        // Description: Kerberoast is a series of tools for attacking MS Kerberos implementations
        // Reference: https://github.com/nidem/kerberoast
        $string17 = /setspn\.exe\s\-T\smedin\s\-Q\s.{0,100}\// nocase ascii wide
        // Description: Kerberoast is a series of tools for attacking MS Kerberos implementations
        // Reference: https://github.com/nidem/kerberoast
