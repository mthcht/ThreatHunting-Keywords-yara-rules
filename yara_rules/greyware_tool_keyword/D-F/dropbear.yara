rule dropbear
{
    ...
    strings:
        ...
        // Description: A smallish SSH server and client
        // Reference: https://github.com/mkj/dropbear
        $string27 = /dropbearconvert\sopenssh\sdropbear/ nocase ascii wide
        // Description: A smallish SSH server and client
        // Reference: https://github.com/mkj/dropbear
        $string28 = /dropbearkey\s\-t\s/ nocase ascii wide
        // Description: A smallish SSH server and client
        // Reference: https://github.com/mkj/dropbear
        $string29 = /dropbearkey\s\-y\s\-f\s/ nocase ascii wide
        // Description: A smallish SSH server and client
        // Reference: https://github.com/mkj/dropbear
        $string30 = /eb912ff679743d91907286544c7326df785a3a6e6992fa182404e3fbae52958a/ nocase ascii wide
        // Description: A smallish SSH server and client
        // Reference: https://github.com/mkj/dropbear
        $string31 = /exec\sdropbear\s/ nocase ascii wide
        // Description: A smallish SSH server and client
        // Reference: https://github.com/mkj/dropbear
