rule MpCmdRun
{
    ...
    strings:
        ...
        // Reference: N/A
        $string1 = /MpCmdRun\.exe\s\-DownloadFile\s\-url\shttp\:\/\/.{0,100}\.exe\s\-path\s/ nocase ascii wide
        // Description: Defense evasion technique disable windows defender
        // Reference: N/A
        $string2 = /MpCmdRun\.exe.{0,100}\s\-disable/ nocase ascii wide
        // Description: Wipe currently stored definitions
        // Reference: N/A
        $string3 = /MpCmdRun\.exe.{0,100}\s\-RemoveDefinitions\s\-All/ nocase ascii wide
