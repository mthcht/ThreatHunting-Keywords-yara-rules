rule Portr
{
    ...
    strings:
        ...
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string14 = /\/portr_.{0,100}_Windows_x86_64\.zip/ nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string15 = /\/portr_admin\/.{0,100}\.py/ nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        ...
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string75 = /portr\s\-c\s.{0,100}\.yaml/ nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
