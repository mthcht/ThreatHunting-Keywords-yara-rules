rule comsvcs_dll
{
    ...
    strings:
        ...
        // Reference: N/A
        $string1 = /comsvcs\.dll.{0,100}\#\+00024764/ nocase ascii wide
        // Description: Dumping credentials with Minidump ordinal format (suspicious)
        // Reference: N/A
        $string2 = /comsvcs\.dll.{0,100}\#24/ nocase ascii wide
        // Description: Dumping lsass credentials
        // Reference: N/A
        $string3 = /comsvcs\.dll.{0,100}MiniDump.{0,100}lsass.{0,100}full/ nocase ascii wide
