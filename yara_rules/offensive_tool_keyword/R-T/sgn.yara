rule sgn
{
    ...
    strings:
        ...
        $string1 = /\sBruteforcing\sbad\scharacters/ nocase ascii wide
        // Description: polymorphic encoder used in  to obfuscate payloads
        // Reference: https://github.com/EgeBalci/sgn
        $string2 = /\ssgn\.exe\s\-i\s/ nocase ascii wide
        // Description: polymorphic encoder used in  to obfuscate payloads
        // Reference: https://github.com/EgeBalci/sgn
        $string3 = /\ssgn_linux\-arm64/ nocase ascii wide
        // Description: polymorphic encoder used in  to obfuscate payloads
        // Reference: https://github.com/EgeBalci/sgn
        ...
        // Description: polymorphic encoder used in  to obfuscate payloads
        // Reference: https://github.com/EgeBalci/sgn
        $string10 = /\/tmp\/\ssgn\s\-i\s\/tmp\// nocase ascii wide
        // Description: polymorphic encoder used in  to obfuscate payloads
        // Reference: https://github.com/EgeBalci/sgn
        ...
        // Description: polymorphic encoder used in  to obfuscate payloads
        // Reference: https://github.com/EgeBalci/sgn
        $string35 = /docker\spull\segee\/sgn/ nocase ascii wide
        // Description: polymorphic encoder used in  to obfuscate payloads
        // Reference: https://github.com/EgeBalci/sgn
        $string36 = /docker\srun\s\-it\segee\/sgn/ nocase ascii wide
        // Description: polymorphic encoder used in  to obfuscate payloads
        // Reference: https://github.com/EgeBalci/sgn
        ...
        // Description: polymorphic encoder used in  to obfuscate payloads
        // Reference: https://github.com/EgeBalci/sgn
        $string42 = /STARTING\sOBFUSCATED\sDECODER\sTESTS\s/ nocase ascii wide
