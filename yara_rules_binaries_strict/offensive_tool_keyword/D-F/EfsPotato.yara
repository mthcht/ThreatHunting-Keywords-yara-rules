rule EfsPotato
{
    ...
    strings:
        ...
        // Description: Exploit for EfsPotato(MS-EFSR EfsRpcOpenFileRaw with SeImpersonatePrivilege local privalege escalation vulnerability)
        // Reference: https://github.com/zcgonvh/EfsPotato
        $string3 = /EfsPotato.{0,100}efsrpc/ nocase ascii wide
        // Description: Exploit for EfsPotato(MS-EFSR EfsRpcOpenFileRaw with SeImpersonatePrivilege local privalege escalation vulnerability)
        // Reference: https://github.com/zcgonvh/EfsPotato
        $string4 = /EfsPotato.{0,100}lsarpc/ nocase ascii wide
        // Description: Exploit for EfsPotato(MS-EFSR EfsRpcOpenFileRaw with SeImpersonatePrivilege local privalege escalation vulnerability)
        // Reference: https://github.com/zcgonvh/EfsPotato
        $string5 = /EfsPotato.{0,100}lsarpc/ nocase ascii wide
        // Description: Exploit for EfsPotato(MS-EFSR EfsRpcOpenFileRaw with SeImpersonatePrivilege local privalege escalation vulnerability)
        // Reference: https://github.com/zcgonvh/EfsPotato
        $string6 = /EfsPotato.{0,100}lsass/ nocase ascii wide
        // Description: Exploit for EfsPotato(MS-EFSR EfsRpcOpenFileRaw with SeImpersonatePrivilege local privalege escalation vulnerability)
        // Reference: https://github.com/zcgonvh/EfsPotato
        $string7 = /EfsPotato.{0,100}netlogon/ nocase ascii wide
        // Description: Exploit for EfsPotato(MS-EFSR EfsRpcOpenFileRaw with SeImpersonatePrivilege local privalege escalation vulnerability)
        // Reference: https://github.com/zcgonvh/EfsPotato
