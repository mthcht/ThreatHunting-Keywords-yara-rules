rule wmiexec_pro
{
    ...
    strings:
        ...
        // Description: The new generation of wmiexec.py with new features whole the operations only work with port 135 (don't need smb connection) for AV evasion in lateral movement
        // Reference: https://github.com/XiaoliChan/wmiexec-Pro
        $string4 = /\sfiletransfer\s\-download\s\-src\-file\s.*\.exe.*\/tmp/ nocase ascii wide
        // Description: The new generation of wmiexec.py with new features whole the operations only work with port 135 (don't need smb connection) for AV evasion in lateral movement
        // Reference: https://github.com/XiaoliChan/wmiexec-Pro
        $string5 = /\sfiletransfer\s\-upload\s\-src\-file\s.*\.exe.*\\temp/ nocase ascii wide
        // Description: The new generation of wmiexec.py with new features whole the operations only work with port 135 (don't need smb connection) for AV evasion in lateral movement
        // Reference: https://github.com/XiaoliChan/wmiexec-Pro
        ...
        // Description: The new generation of wmiexec.py with new features whole the operations only work with port 135 (don't need smb connection) for AV evasion in lateral movement
        // Reference: https://github.com/XiaoliChan/wmiexec-Pro
        $string9 = /\.py\s.*\samsi\s\-disable/ nocase ascii wide
        // Description: The new generation of wmiexec.py with new features whole the operations only work with port 135 (don't need smb connection) for AV evasion in lateral movement
        // Reference: https://github.com/XiaoliChan/wmiexec-Pro
        $string10 = /\.py\s.*\samsi\s\-enable/ nocase ascii wide
        // Description: The new generation of wmiexec.py with new features whole the operations only work with port 135 (don't need smb connection) for AV evasion in lateral movement
        // Reference: https://github.com/XiaoliChan/wmiexec-Pro
        $string11 = /\.py.*\sservice\s\-action\screate\s\-service\-name\s/ nocase ascii wide
        // Description: The new generation of wmiexec.py with new features whole the operations only work with port 135 (don't need smb connection) for AV evasion in lateral movement
        // Reference: https://github.com/XiaoliChan/wmiexec-Pro
