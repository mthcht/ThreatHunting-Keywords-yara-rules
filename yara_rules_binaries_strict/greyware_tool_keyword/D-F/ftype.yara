rule ftype
{
    ...
    strings:
        ...
        // Reference: N/A
        $string1 = /ftype\s.{0,100}findstr\s.{0,100}dfil/ nocase ascii wide
        ...
        // Reference: N/A
        $string2 = /ftype\s.{0,100}findstr\s.{0,100}SHCm/ nocase ascii wide
        // Description: will return the file type information for file types that include the string dfil - hidden objectif is to find cmdfile string
        // Reference: N/A
        $string3 = /ftype\s.{0,100}findstr\sdfil/ nocase ascii wide
        // Description: will return the file type information for file types that include the string SHCm - hidden objectif is to find SHCmdFile string
        // Reference: N/A
        $string4 = /ftype\s.{0,100}findstr\sSHCm/ nocase ascii wide
