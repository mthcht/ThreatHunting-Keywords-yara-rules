rule wmic
{
    ...
    strings:
        ...
        $string1 = /.{0,1000}wmic\s\/namespace:\\\\root\\default\spath\sstdRegProv\scall\sDeleteValue\s.{0,1000}SOFTWARE\\YourSoftware\\Schedule\\TaskCache\\Tree\\.{0,1000}\=.{0,1000}SD.{0,1000}/ nocase ascii wide
