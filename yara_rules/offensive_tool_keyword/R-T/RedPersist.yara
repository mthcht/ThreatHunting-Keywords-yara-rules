rule RedPersist
{
    ...
    strings:
        ...
        $string1 = /\.exe\s\-\-eventviewer\s.*\.exe/ nocase ascii wide
        // Description: RedPersist is a Windows Persistence tool written in C#
        // Reference: https://github.com/mertdas/RedPersist
        $string2 = /\.exe\s\-\-pwsh\s.*\.ps1\s.*\.exe/ nocase ascii wide
        // Description: RedPersist is a Windows Persistence tool written in C#
        // Reference: https://github.com/mertdas/RedPersist
        $string3 = /\.exe\s\-\-schedule\s.*\s.*\.exe/ nocase ascii wide
        // Description: RedPersist is a Windows Persistence tool written in C#
        // Reference: https://github.com/mertdas/RedPersist
        $string4 = /\.exe\s\-\-screensaver\s.*:\\.*\.exe/ nocase ascii wide
        // Description: RedPersist is a Windows Persistence tool written in C#
        // Reference: https://github.com/mertdas/RedPersist
        $string5 = /\.exe\s\-\-startup\s.*:\\.*\.exe/ nocase ascii wide
        // Description: RedPersist is a Windows Persistence tool written in C#
        // Reference: https://github.com/mertdas/RedPersist
        $string6 = /\.exe\s\-\-winlogon\s.*\s.*:\\.*\.exe/ nocase ascii wide
        // Description: RedPersist is a Windows Persistence tool written in C#
        // Reference: https://github.com/mertdas/RedPersist
        $string7 = /\.exe\s\-\-wmi\s.*:\\.*\.exe/ nocase ascii wide
        // Description: RedPersist is a Windows Persistence tool written in C#
        // Reference: https://github.com/mertdas/RedPersist
