rule pupy
{
    ...
    strings:
        ...
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        $string19 = /\/all\/pupyutils\/.*\.py/ nocase ascii wide
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        ...
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        $string35 = /\/pupwinutils\/.*\.py/ nocase ascii wide
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        $string36 = /\/pupy\/.*\.py/ nocase ascii wide
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        ...
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        $string39 = /\/pupy\/output\/pupyx64.*\.exe/ nocase ascii wide
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        ...
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        $string58 = /\/transports\/scramblesuit\/.*\.py/ nocase ascii wide
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        ...
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        $string87 = /pupy.*\/checkvm\.py/ nocase ascii wide
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        ...
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        $string108 = /run\s.*\spyshell/ nocase ascii wide
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        ...
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
        $string113 = /run\smemory_exec\s.*\./ nocase ascii wide
        // Description: Pupy is an opensource. cross-platform (Windows. Linux. OSX. Android) C2 and post-exploitation framework written in python and C
        // Reference: https://github.com/n1nj4sec/pupy
