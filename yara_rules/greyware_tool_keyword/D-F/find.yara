rule find
{
    ...
    strings:
        ...
        // Reference: N/A
        $string3 = /find\s\/\s\-name\sauthorized_keys\s.*\>\s\/dev\/null/ nocase ascii wide
        ...
        // Description: Find sensitive files
        // Reference: N/A
        $string5 = /find\s\/\s\-name\sid_rsa\s.*\>\s\/dev\/null/ nocase ascii wide
        // Description: linux commands abused by attackers - find guid and suid sensitives perm
        // Reference: N/A
        ...
        // Description: Find SUID enabled files
        // Reference: N/A
        $string16 = /find\s\/\s\-perm\s\-u\=s\s\-type\sf\s\-group\s.*\/dev\/null/ nocase ascii wide
        // Description: Find SUID enabled files
        // Reference: N/A
        ...
        // Description: linux commands abused by attackers - find guid and suid sensitives perm
        // Reference: N/A
        $string19 = /find\s\/.*\s\-perm\s\-04000\s\-o\s\-perm\s\-02000/ nocase ascii wide
        // Description: linux commands abused by attackers - find guid and suid sensitives perm
        // Reference: N/A
        $string20 = /find\s\/.*\s\-perm\s\-u\=s\s\-type\sf\s2\>/ nocase ascii wide
