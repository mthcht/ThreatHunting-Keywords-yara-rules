rule micr0_shell
{
    ...
    strings:
        ...
        $string1 = /\s\-\-execution\sfalse\s\-\-save\sTrue\s\-\-output\s.*\.bin/ nocase ascii wide
        // Description: micr0shell is a Python script that dynamically generates Windows X64 PIC Null-Free reverse shell shellcode.
        // Reference: https://github.com/senzee1984/micr0_shell
        $string2 = /\s\-\-ip\s.*\s\-\-port\s.*\s\-\-type\scmd\s\-\-language\s/ nocase ascii wide
        // Description: micr0shell is a Python script that dynamically generates Windows X64 PIC Null-Free reverse shell shellcode.
        // Reference: https://github.com/senzee1984/micr0_shell
        $string3 = /\s\-\-ip\s.*\s\-\-variable\sshellcode\s/ nocase ascii wide
        // Description: micr0shell is a Python script that dynamically generates Windows X64 PIC Null-Free reverse shell shellcode.
        // Reference: https://github.com/senzee1984/micr0_shell
