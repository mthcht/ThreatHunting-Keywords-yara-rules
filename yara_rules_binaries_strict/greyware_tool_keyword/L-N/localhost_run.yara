rule localhost_run
{
    ...
    strings:
        ...
        $string1 = /http\:\/\/.{0,100}\.localhost\.run/ nocase ascii wide
        // Description: Put a locally running HTTP HTTPS or TLS app on the internet
        // Reference: https://localhost.run/
        $string2 = /https\:\/\/.{0,100}\.localhost\.run/ nocase ascii wide
        // Description: Put a locally running HTTP HTTPS or TLS app on the internet
        // Reference: https://localhost.run/
        $string3 = /ssh\s.{0,100}\s\.localhost\.run/ nocase ascii wide
        // Description: Put a locally running HTTP HTTPS or TLS app on the internet
        // Reference: https://localhost.run/
        $string4 = /ssh\s.{0,100}\slocalhost\.run/ nocase ascii wide
