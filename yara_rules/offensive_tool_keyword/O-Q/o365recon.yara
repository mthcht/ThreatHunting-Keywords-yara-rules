rule o365recon
{
    ...
    strings:
        ...
        // Description: script to retrieve information via O365 and AzureAD with a valid cred 
        // Reference: https://github.com/nyxgeek/o365recon
        $string2 = /\\.*\.O365\.GroupMembership_AdminGroups\.txt/ nocase ascii wide
        // Description: script to retrieve information via O365 and AzureAD with a valid cred 
        // Reference: https://github.com/nyxgeek/o365recon
        $string3 = /\\.*\.O365\.GroupMembership_VPNGroups\.txt/ nocase ascii wide
        // Description: script to retrieve information via O365 and AzureAD with a valid cred 
        // Reference: https://github.com/nyxgeek/o365recon
        $string4 = /\\.*\.O365\.Roles_Admins\.txt/ nocase ascii wide
