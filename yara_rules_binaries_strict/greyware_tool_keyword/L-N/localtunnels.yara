rule localtunnels
{
    ...
    strings:
        ...
        $string1 = /\sinstall\slocaltunnel/ nocase ascii wide
        ...
        $string2 = /\slocaltunnel\-server/ nocase ascii wide
        // Description: client for localtunnel.me - localtunnel exposes your localhost to the world for easy testing and sharing
        // Reference: https://github.com/localtunnel/localtunnel
        ...
        // Description: client for localtunnel.me - localtunnel exposes your localhost to the world for easy testing and sharing
        // Reference: https://github.com/localtunnel/localtunnel
        $string8 = /bin\/lt\s\-\-host\shttps\:\/\// nocase ascii wide
        // Description: client for localtunnel.me - localtunnel exposes your localhost to the world for easy testing and sharing
        // Reference: https://github.com/localtunnel/localtunnel
        ...
        // Description: client for localtunnel.me - localtunnel exposes your localhost to the world for easy testing and sharing
        // Reference: https://github.com/localtunnel/localtunnel
        $string15 = /npm\sinstall\s\-g\slocaltunnel/ nocase ascii wide
        // Description: client for localtunnel.me - localtunnel exposes your localhost to the world for easy testing and sharing
        // Reference: https://github.com/localtunnel/localtunnel
        $string16 = /npm\sinstall\s\-g\slocaltunnel/ nocase ascii wide
        // Description: client for localtunnel.me - localtunnel exposes your localhost to the world for easy testing and sharing
        // Reference: https://github.com/localtunnel/localtunnel
        $string17 = /npx\slocaltunnel\s\-\-port\s/ nocase ascii wide
