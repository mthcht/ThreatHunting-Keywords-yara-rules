rule LAPSDumper
{
    ...
    strings:
        ...
        $string1 = /\slaps\.py\s.*\-\-ldapserver/ nocase ascii wide
        // Description: Dumping LAPS from Python
        // Reference: https://github.com/n00py/LAPSDumper
        $string2 = /\slaps\.py\s.*\-u\s.*\s\-p\s/ nocase ascii wide
        // Description: Dumping LAPS from Python
        // Reference: https://github.com/n00py/LAPSDumper
        $string3 = /\/laps\.py\s.*\-\-ldapserver/ nocase ascii wide
        // Description: Dumping LAPS from Python
        // Reference: https://github.com/n00py/LAPSDumper
        $string4 = /\/laps\.py\s.*\-u\s.*\s\-p\s/ nocase ascii wide
        // Description: Dumping LAPS from Python
        // Reference: https://github.com/n00py/LAPSDumper
