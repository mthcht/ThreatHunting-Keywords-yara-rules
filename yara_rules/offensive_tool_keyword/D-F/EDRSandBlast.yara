rule EDRSandBlast
{
    ...
    strings:
        ...
        $string1 = /\s\-\-nt\-offsets\s.*\.csv/ nocase ascii wide
        // Description: EDRSandBlast is a tool written in C that weaponize a vulnerable signed driver to bypass EDR detections
        // Reference: https://github.com/wavestone-cdt/EDRSandblast
        ...
        // Description: EDRSandBlast is a tool written in C that weaponize a vulnerable signed driver to bypass EDR detections
        // Reference: https://github.com/wavestone-cdt/EDRSandblast
        $string15 = /lsass\.exe.*C:\\temp\\tmp\.tmp/ nocase ascii wide
        // Description: EDRSandBlast is a tool written in C that weaponize a vulnerable signed driver to bypass EDR detections
        // Reference: https://github.com/wavestone-cdt/EDRSandblast
        $string16 = /LSASSProtectionBypass.*\// nocase ascii wide
        // Description: EDRSandBlast is a tool written in C that weaponize a vulnerable signed driver to bypass EDR detections
        // Reference: https://github.com/wavestone-cdt/EDRSandblast
        ...
        // Description: EDRSandBlast is a tool written in C that weaponize a vulnerable signed driver to bypass EDR detections
        // Reference: https://github.com/wavestone-cdt/EDRSandblast
        $string19 = /\-\-wdigest\-offsets\s.*\.csv\s/ nocase ascii wide
        // Description: EDRSandBlast is a tool written in C that weaponize a vulnerable signed driver to bypass EDR detections
        // Reference: https://github.com/wavestone-cdt/EDRSandblast
