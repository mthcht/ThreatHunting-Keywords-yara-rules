rule Compress_Archive
{
    ...
    strings:
        ...
        // Description: Compress data using zlib for exfiltration
        // Reference: https://www.cisa.gov/news-events/cybersecurity-advisories/aa23-347a
        $string2 = /Compress\-Archive\s\-Path.{0,100}\-DestinationPath\s\$env\:TEMP/ nocase ascii wide
        // Description: Compress data using zlib for exfiltration
        // Reference: https://www.cisa.gov/news-events/cybersecurity-advisories/aa23-347a
        $string3 = /Compress\-Archive\s\-Path.{0,100}\-DestinationPath.{0,100}\:\\Windows\\Temp\\/ nocase ascii wide
        // Description: Compress data using zlib for exfiltration
        // Reference: https://www.cisa.gov/news-events/cybersecurity-advisories/aa23-347a
        $string4 = /Compress\-Archive\s\-Path.{0,100}\-DestinationPath.{0,100}\\AppData\\Local\\Temp\\\'/ nocase ascii wide
