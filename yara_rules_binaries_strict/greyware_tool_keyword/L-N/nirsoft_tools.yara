rule nirsoft_tools
{
    ...
    strings:
        ...
        $string2 = /https\:\/\/www\.nirsoft\.net\/toolsdownload\/.{0,100}\.exe/ nocase ascii wide
        // Description: some of nirsoft tools can be abused by attackers to retrieve passwords 
        // Reference: nirsoft.net
        $string3 = /https\:\/\/www\.nirsoft\.net\/toolsdownload\/.{0,100}\.zip/ nocase ascii wide
        // Description: some of nirsoft tools can be abused by attackers to retrieve passwords 
        // Reference: nirsoft.net
        $string4 = /https\:\/\/www\.nirsoft\.net\/utils\/.{0,100}\.exe/ nocase ascii wide
        // Description: some of nirsoft tools can be abused by attackers to retrieve passwords 
        // Reference: nirsoft.net
        $string5 = /https\:\/\/www\.nirsoft\.net\/utils\/.{0,100}\.zip/ nocase ascii wide
