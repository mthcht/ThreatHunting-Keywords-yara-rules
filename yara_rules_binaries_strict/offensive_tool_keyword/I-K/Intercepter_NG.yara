rule Intercepter_NG
{
    ...
    strings:
        ...
        $string1 = /\/Intercepter\-NG.{0,100}\.apk/ nocase ascii wide
        // Description: android wifi sniffer
        // Reference: https://github.com/intercepter-ng
        $string2 = /http\:\/\/sniff\.su\/.{0,100}\.gz/ nocase ascii wide
        // Description: android wifi sniffer
        // Reference: https://github.com/intercepter-ng
        $string3 = /http\:\/\/sniff\.su\/.{0,100}\.zip/ nocase ascii wide
        // Description: android wifi sniffer
        // Reference: https://github.com/intercepter-ng
        $string4 = /https\:\/\/sniff\.su\/.{0,100}\.gz/ nocase ascii wide
        // Description: android wifi sniffer
        // Reference: https://github.com/intercepter-ng
