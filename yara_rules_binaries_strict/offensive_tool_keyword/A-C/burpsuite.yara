rule burpsuite
{
    ...
    strings:
        ...
        $string20 = /burp.{0,100}PayloadParser\.py/ nocase ascii wide
        // Description: CO2 is a project for lightweight and useful enhancements to Portswigger popular Burp Suite web penetration tool through the standard Extender API
        // Reference: https://github.com/JGillam/burp-co2
        $string21 = /burp.{0,100}SQLMapper\.xml/ nocase ascii wide
        // Description: PayloadParser - Burp Suite NMap Parsing Interface in Python
        // Reference: https://github.com/infodel/burp.extension-payloadparser
        ...
        // Description: The class-leading vulnerability scanning. penetration testing. and web app security platform
        // Reference: https://portswigger.net/burp
        $string31 = /burpsuite.{0,100}\.exe/ nocase ascii wide
        // Description: The class-leading vulnerability scanning. penetration testing. and web app security platform
        // Reference: https://portswigger.net/burp
        $string32 = /burpsuite.{0,100}\.jar/ nocase ascii wide
        // Description: The class-leading vulnerability scanning. penetration testing. and web app security platform
        // Reference: https://portswigger.net/burp
        $string33 = /burpsuite.{0,100}\.sh/ nocase ascii wide
        // Description: The class-leading vulnerability scanning. penetration testing. and web app security platform
        // Reference: https://portswigger.net/burp
        $string34 = /burpsuite.{0,100}\.zip/ nocase ascii wide
        // Description: Collection of burpsuite plugins
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        ...
        // Description: Collection of burpsuite plugins
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string37 = /burp\-vulners\-scanner\-.{0,100}\.jar/ nocase ascii wide
        ...
        // Description: Collection of burpsuite plugins
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string40 = /captcha\-killer\..{0,100}\.jar/ nocase ascii wide
        // Description: The class-leading vulnerability scanning. penetration testing. and web app security platform
        // Reference: https://portswigger.net/burp
        ...
        // Description: Collection of burpsuite plugins
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string46 = /domain_hunter\-v.{0,100}\.jar/ nocase ascii wide
        // Description: Collection of burpsuite plugins
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        ...
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string51 = /http\:\/\/.{0,100}\.oast\.fun\// nocase ascii wide
        // Description: domains used by burp collaborator - abused for  payload callback
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string52 = /http\:\/\/.{0,100}\.oast\.live\// nocase ascii wide
        // Description: domains used by burp collaborator - abused for  payload callback
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string53 = /http\:\/\/.{0,100}\.oast\.me\// nocase ascii wide
        // Description: domains used by burp collaborator - abused for  payload callback
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string54 = /http\:\/\/.{0,100}\.oast\.online\// nocase ascii wide
        // Description: domains used by burp collaborator - abused for  payload callback
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string55 = /http\:\/\/.{0,100}\.oast\.pro\// nocase ascii wide
        // Description: domains used by burp collaborator - abused for  payload callback
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string56 = /http\:\/\/.{0,100}\.oast\.site\// nocase ascii wide
        // Description: domains used by burp collaborator - abused for  payload callback
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string57 = /http\:\/\/.{0,100}\.oastify\.com\// nocase ascii wide
        // Description: Collection of burpsuite plugins
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        ...
        // Description: Collection of burpsuite plugins
        // Reference: https://github.com/Mr-xn/BurpSuite-collections
        $string75 = /sqlmap4burp.{0,100}\.jar/ nocase ascii wide
