rule Dataplicity
{
    ...
    strings:
        ...
        // Description: enables connecting local systems to dataplicity cloud for remotely accessing them over the internet.
        // Reference: https://github.com/wildfoundry/dataplicity-agent
        $string89 = /from\slomond\simport\sWebSocket/ nocase ascii wide
        // Description: enables connecting local systems to dataplicity cloud for remotely accessing them over the internet.
        // Reference: https://github.com/wildfoundry/dataplicity-agent
        $string90 = /https\:\/\/www\.dataplicity\.com\/.{0,1000}\.py/ nocase ascii wide
        // Description: enables connecting local systems to dataplicity cloud for remotely accessing them over the internet.
        // Reference: https://github.com/wildfoundry/dataplicity-agent
        ...
        // Description: enables connecting local systems to dataplicity cloud for remotely accessing them over the internet.
        // Reference: https://github.com/wildfoundry/dataplicity-agent
        $string93 = /USER_AGENT\s\=\s\'Lomond\// nocase ascii wide
        // Description: enables connecting local systems to dataplicity cloud for remotely accessing them over the internet.
        // Reference: https://github.com/wildfoundry/dataplicity-agent
