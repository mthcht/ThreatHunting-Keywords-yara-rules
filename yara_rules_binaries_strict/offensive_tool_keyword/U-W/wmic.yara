rule wmic
{
    ...
    strings:
        ...
        $string1 = /wmic\s\/namespace\:\\\\root\\default\spath\sstdRegProv\scall\sDeleteValue\s.{0,100}SOFTWARE\\YourSoftware\\Schedule\\TaskCache\\Tree\\.{0,100}\=.{0,100}SD/ nocase ascii wide
