rule JohnTheRipper
{
    ...
    strings:
        ...
        $string1 = /\s\-\-format\=NT\s\-w\=.{0,1000}_password\.txt/ nocase ascii wide
        // Description: John the Ripper is a fast password cracker.
        // Reference: https://github.com/magnumripper/JohnTheRipper
        $string2 = /john\s.{0,1000}\s\-\-wordlist\=/ nocase ascii wide
        // Description: John the Ripper is a fast password cracker.
        // Reference: https://github.com/magnumripper/JohnTheRipper
        $string3 = /john\sNTDS\.dit/ nocase ascii wide
        // Description: John the Ripper is a fast password cracker.
        // Reference: https://github.com/magnumripper/JohnTheRipper
        $string4 = /John.{0,1000}the.{0,1000}Ripper/ nocase ascii wide
