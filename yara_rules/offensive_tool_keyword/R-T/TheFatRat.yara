rule TheFatRat
{
    ...
    strings:
        ...
        $string1 = /.{0,1000}\/backdoor_apk.{0,1000}/ nocase ascii wide
        // Description: Easy tool to generate backdoor and easy tool to post exploitation attack like browser attack and dll.
        // Reference: https://github.com/Screetsec/TheFatRat
        $string2 = /.{0,1000}\/cred_dump\.rc.{0,1000}/ nocase ascii wide
        // Description: Easy tool to generate backdoor and easy tool to post exploitation attack like browser attack and dll.
        // Reference: https://github.com/Screetsec/TheFatRat
        $string3 = /.{0,1000}\/TheFatRat.{0,1000}/ nocase ascii wide
