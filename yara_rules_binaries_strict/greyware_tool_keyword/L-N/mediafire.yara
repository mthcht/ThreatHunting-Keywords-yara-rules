rule mediafire
{
    ...
    strings:
        ...
        // Reference: N/A
        $string1 = /\/download.{0,100}mediafire\.com\// nocase ascii wide
        // Description: downloading from mediafire
        // Reference: N/A
        $string2 = /https\:\/\/www\.mediafire\.com\/api\/.{0,100}\/folder\/get_content\.php/ nocase ascii wide
        ...
        // Reference: N/A
        $string5 = /www\.mediafire\.com\/file\/.{0,100}\.rar\/file/ nocase ascii wide
        // Description: uploading to mediafire
        // Reference: N/A
