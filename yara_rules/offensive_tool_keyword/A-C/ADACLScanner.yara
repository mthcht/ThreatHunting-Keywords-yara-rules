rule ADACLScanner
{
    ...
    strings:
        ...
        $string1 = /\.ps1\s\-Base\s.*OU\=.*DC\=.*\s\-Credentials\s.*\s\-Server\s/ nocase ascii wide
        // Description: A tool with GUI used to create reports of access control lists (DACLs) and system access control lists (SACLs) in Active Directory .
        // Reference: https://github.com/canix1/ADACLScanner
        $string2 = /\/ADACLScanner\.git/ nocase ascii wide
        // Description: A tool with GUI used to create reports of access control lists (DACLs) and system access control lists (SACLs) in Active Directory .
        // Reference: https://github.com/canix1/ADACLScanner
        $string3 = /_adAclOutput.*\.csv/ nocase ascii wide
        // Description: A tool with GUI used to create reports of access control lists (DACLs) and system access control lists (SACLs) in Active Directory .
        // Reference: https://github.com/canix1/ADACLScanner
        $string4 = /_adAclOutput.*\.csv/ nocase ascii wide
        // Description: A tool with GUI used to create reports of access control lists (DACLs) and system access control lists (SACLs) in Active Directory .
        // Reference: https://github.com/canix1/ADACLScanner
        $string5 = /_adAclOutput.*\.csv/ nocase ascii wide
        // Description: A tool with GUI used to create reports of access control lists (DACLs) and system access control lists (SACLs) in Active Directory .
        // Reference: https://github.com/canix1/ADACLScanner
        $string6 = /_adAclOutput.*\.csv/ nocase ascii wide
        // Description: A tool with GUI used to create reports of access control lists (DACLs) and system access control lists (SACLs) in Active Directory .
        // Reference: https://github.com/canix1/ADACLScanner
        $string7 = /_adAclOutput.*\.csv/ nocase ascii wide
        // Description: A tool with GUI used to create reports of access control lists (DACLs) and system access control lists (SACLs) in Active Directory .
        // Reference: https://github.com/canix1/ADACLScanner
        $string8 = /_adAclOutput.*\.xlsx/ nocase ascii wide
        // Description: A tool with GUI used to create reports of access control lists (DACLs) and system access control lists (SACLs) in Active Directory .
        // Reference: https://github.com/canix1/ADACLScanner
