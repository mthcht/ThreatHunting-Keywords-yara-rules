rule Portr
{
    ...
    strings:
        ...
        $string1 = " on http://localhost:7777" nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string2 = " Portr inspector running on " nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        ...
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string9 = /\/portr_.{0,1000}_Darwin_arm64\.zip/
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string10 = /\/portr_.{0,1000}_Darwin_x86_64\.zip/
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string11 = /\/portr_.{0,1000}_Linux_arm64\.zip/
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string12 = /\/portr_.{0,1000}_Linux_x86_64\.zip/
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        ...
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string73 = "Portr - Expose local ports to public URLs" nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string74 = "portr auth set --token " nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string75 = /portr\s\-c\s.{0,1000}\.yaml/ nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string76 = "portr http " nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
        $string77 = "portr tcp " nocase ascii wide
        // Description: Portr is a tunnel solution that allows you to expose local http, tcp or websocket connections to the public internet
        // Reference: https://github.com/amalshaji/portr
