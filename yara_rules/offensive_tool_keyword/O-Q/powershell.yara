rule powershell
{
    ...
    strings:
        ...
        // Reference: N/A
        $string22 = /Get\-ADComputer\s.{0,1000}\s\-Properties\sPrincipalsAllowedToDelegateToAccount/ nocase ascii wide
        ...
        $string23 = /http\:\/\/.{0,1000}Microsoft\.ActiveDirectory\.Management\.dll/ nocase ascii wide
        // Description: redteam technique - import the ActiveDirectory module without the need to install it on the current computer - the dll has been extracted from a Windows 10 x64 with RSAT installed
        // Reference: https://github.com/mthcht/Purpleteam/blob/main/Simulation/Windows/ActiveDirectory/Bruteforce.ps1
        $string24 = /https\:\/\/.{0,1000}Microsoft\.ActiveDirectory\.Management\.dll/ nocase ascii wide
        // Description: redteam technique - import the ActiveDirectory module without the need to install it on the current computer - the dll has been extracted from a Windows 10 x64 with RSAT installed
        // Reference: https://github.com/mthcht/Purpleteam/blob/main/Simulation/Windows/ActiveDirectory/Bruteforce.ps1
        $string25 = /Import\-Module\s.{0,1000}Microsoft\.ActiveDirectory\.Management\.dll/ nocase ascii wide
        ...
        $string28 = /Remove\-Item\s\(Get\-PSreadlineOption\)\.HistorySavePath/ nocase ascii wide
